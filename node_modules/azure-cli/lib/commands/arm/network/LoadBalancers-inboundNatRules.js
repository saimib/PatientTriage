...
exports.init = function(cli) {
  ...
  var inboundNatRules = loadBalancers.category("inbound-nat-rule").description($("Commands to manage inbound nat rules"));
          ...
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 4, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                ...
                if (utils.findFirstCaseIgnore(loadBalancer.inboundNatRules, { name: name })) {
                  return _(new Error(util.format($("inbound nat rules with name \"%s\" already exists in the \"%s\""), name, lbName))); } ;
                ...
                if (options.frontendIpId) {
                  ...
                  parameters.inboundNatRules[index].frontendIPConfiguration.id = options.frontendIpId; } else {
                  if (options.frontendIpName) {
                    ...
                    parameters.inboundNatRules[index].frontendIPConfiguration.id = idContainerfrontendIPConfiguration.id; } else {
                    if (useDefaults) {
                ...
                if (options.protocol) {
                  parameters.inboundNatRules[index].protocol = validation.isIn(options.protocol, ["Udp","Tcp",], "--protocol"); } else {
                  if (useDefaults) {
                    parameters.inboundNatRules[index].protocol = defaultProtocol; } ; } ;


                if (options.frontendPort) {
                  parameters.inboundNatRules[index].frontendPort = parseInt(options.frontendPort, 10); } else {
                  if (useDefaults) {
                    parameters.inboundNatRules[index].frontendPort = parseInt(defaultFrontendPort, 10); } ; } ;


                if (options.backendPort) {
                  parameters.inboundNatRules[index].backendPort = parseInt(options.backendPort, 10); } else {
                  if (useDefaults) {
                    parameters.inboundNatRules[index].backendPort = parseInt(defaultBackendPort, 10); } ; } ;


                if (options.idleTimeout) {
                  parameters.inboundNatRules[index].idleTimeoutInMinutes = parseInt(options.idleTimeout, 10); } else {
                  if (useDefaults) {
                    parameters.inboundNatRules[index].idleTimeoutInMinutes = parseInt(defaultIdleTimeoutInMinutes, 10); } ; } ;


                if (options.enableFloatingIp) {
                  parameters.inboundNatRules[index].enableFloatingIP = utils.parseBool(options.enableFloatingIp); } else {
                  if (useDefaults) {
                ...
                progress = cli.interaction.progress(util.format($("Creating inbound nat rules in \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {

                      return networkManagementClient.loadBalancers.createOrUpdate(resourceGroup, lbName, loadBalancer, __cb(_, __frame, 98, 61, function ___(__0, __5) { loadBalancer = __5; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__1() {

                        progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$__1() {


                    cli.interaction.formatOutput(loadBalancer.inboundNatRules[generatorUtils.findIndexByKeyValue(loadBalancer.inboundNatRules, "name", name)], generatorUtils.traverse); _(); }); }); }); }); }, true)); }, true)); }, true)); }); });


  inboundNatRules.command("set [resource-group] [lb-name] [name]").description($("Update an inbound nat rules")).usage("[options] <resource-group> <lb-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-l, --lb-name <lb-name>", $("the lb name")).option("-n, --name <name>", $("the name of the inbound nat rule")).option("-t, --frontend-ip-name [frontend-ip-name]", $(("sets frontend ip configuration. This" + "\n     option is mutually exclusive with --frontend-ip-id"))).option("-s, --frontend-ip-id [frontend-ip-id]", $(("sets frontend ip configuration. This" + "\n     option is mutually exclusive with --frontend-ip-name"))).option("-p, --protocol [protocol]", $(("the transport protocol for the" + "\n     endpoint. Possible values are: 'Udp' or 'Tcp'"))).option("-f, --frontend-port [frontend-port]", $((("the port for the external endpoint." + "\n     Port numbers for each Rule must be unique within the Load Balancer. Acceptable") + "\n     values range from 1 to 65534"))).option("-b, --backend-port [backend-port]", $(("the port used for the internal" + "\n     endpoint. Acceptable values range from 1 to 65535"))).option("-i, --idle-timeout [idle-timeout]", $((("the timeout for the TCP idle" + "\n     connection. The value can be set between 4 and 30 minutes. The default value is") + "\n     4 minutes. This element is only used when the protocol is set to TCP"))).option("-e, --enable-floating-ip [enable-floating-ip]", $((((("configures a virtual machine's" + "\n     endpoint for the floating IP capability required to configure a SQL AlwaysOn") + "\n     Availability Group. This setting is required when using the SQL AlwaysOn") + "\n     Availability Groups in SQL server. This setting can't be changed after you") + "\n     create the endpoint"))).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, lbName, name, options, _) { var useDefaults, subscription, networkManagementClient, loadBalancer, progress, inboundNatRule, index, parameters, referredfrontendIPConfiguration, idContainerfrontendIPConfiguration; var __frame = { name: "__2", line: 205 }; return __func(_, this, arguments, __2, 4, __frame, function __$__2() {
        ...
        return cli.interaction.promptIfNotGiven($("lb name : "), lbName, __cb(_, __frame, 3, 31, function ___(__0, __2) { lbName = __2;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 4, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
                ...
                inboundNatRule = utils.findFirstCaseIgnore(loadBalancer.inboundNatRules, { name: name });
                index = utils.indexOfCaseIgnore(loadBalancer.inboundNatRules, { name: name });
                if (!inboundNatRule) {
                  return _(new Error(util.format($("inbound nat rules with name \"%s\" not found in the \"%s\""), name, lbName))); } ;
                ...
                generatorUtils.removeEmptyObjects(parameters);
                progress = cli.interaction.progress(util.format($("Updating inbound nat rules in \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {

                      return networkManagementClient.loadBalancers.createOrUpdate(resourceGroup, lbName, loadBalancer, __cb(_, __frame, 90, 61, function ___(__0, __5) { loadBalancer = __5; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__2() {

                        progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$__2() {

                    cli.interaction.formatOutput(loadBalancer.inboundNatRules[index], generatorUtils.traverse); _(); }); }); }); }); }, true)); }, true)); }, true)); }); });


  inboundNatRules.command("delete [resource-group] [lb-name] [name]").description($("Delete a inbound nat rules")).usage("[options] <resource-group> <lb-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-l, --lb-name <lb-name>", $("the lb name")).option("-n, --name <name>", $("the name of the inbound nat rule")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __3(resourceGroup, lbName, name, options, _) { var subscription, networkManagementClient, loadBalancer, progress, index; var __frame = { name: "__3", line: 310 }; return __func(_, this, arguments, __3, 4, __frame, function __$__3() {
        ...
        return cli.interaction.promptIfNotGiven($("lb name : "), lbName, __cb(_, __frame, 2, 31, function ___(__0, __3) { lbName = __3;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __4) { name = __4;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
                ...
                index = utils.indexOfCaseIgnore(loadBalancer.inboundNatRules, { name: name });
                if ((index === -1)) {
                  return _(new Error(util.format($("inbound nat rules \"%s\" not found in the lbName \"%s\""), name, loadBalancer.name))); } ; return (function __$__3(_) {


                  var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete inbound nat rules with name \"%s\" from \"%s\"? [y/n] "), name, lbName), __cb(_, __frame, 31, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -309, 17, function ___(__0, __6) { return (function __$__3(__then) { if (__6) { return _(null); } else { __then(); } ; })(function __$__3() {



                    loadBalancer.inboundNatRules.splice(index, 1);
                    progress = cli.interaction.progress("Deleting inbound nat rules"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
  ...
  inboundNatRules.command("show [resource-group] [lb-name] [name]").description($("Show an inbound nat rules")).usage("[options] <resource-group> <lb-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-l, --lb-name <lb-name>", $("the lb name")).option("-n, --name <name>", $("the name of the inbound nat rule")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, lbName, name, options, _) { var subscription, networkManagementClient, loadBalancer, progress, inboundNatRule; var __frame = { name: "__4", line: 361 }; return __func(_, this, arguments, __4, 4, __frame, function __$__4() {
        ...
        return cli.interaction.promptIfNotGiven($("lb name : "), lbName, __cb(_, __frame, 2, 31, function ___(__0, __2) { lbName = __2;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__4() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__4() {
                ...
                cli.interaction.formatOutput(inboundNatRule, generatorUtils.traverse); _(); }); }); }, true)); }, true)); }, true)); }); });


  inboundNatRules.command("list [resource-group] [lb-name]").description($("List inbound nat rules")).usage("[options] <resource-group> <lb-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-l, --lb-name <lb-name>", $("the lb name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(resourceGroup, lbName, options, _) { var subscription, networkManagementClient, loadBalancer, progress, items; var __frame = { name: "__5", line: 401 }; return __func(_, this, arguments, __5, 3, __frame, function __$__5() {
      ...
      progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__5() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__5() {
          ...
          items = loadBalancer.inboundNatRules;
