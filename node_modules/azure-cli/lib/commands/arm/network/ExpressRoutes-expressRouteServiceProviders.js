...
exports.init = function(cli) {
  ...
  expressRouteServiceProviders.command("list").description($("List express route service providers")).usage("[options]").option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __1(options, _) { var subscription, networkManagementClient, expressRouteServiceProvider, progress; var __frame = { name: "__1", line: 41 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
