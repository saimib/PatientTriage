...
exports.init = function(cli) {
          ...
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the application gateway \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                ...
                if (utils.findFirstCaseIgnore(applicationGateway.sslCertificates, { name: name })) {
                  return _(new Error(util.format($("ssl certificates with name \"%s\" already exists in the \"%s\""), name, gatewayName))); } ;
                ...
                if (options.certPassword) {
                  parameters.sslCertificates[index].password = options.certPassword; } ; return (function __$__1(__then) {
                  ...
                  if (options.certFile) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                          ...
                          parameters.sslCertificates[index].data = data.toString("base64"); __then(); }); })(function ___(err, __result) { __catch(function __$__1() { if (err) {
                  ...
                  progress = cli.interaction.progress(util.format($("Creating ssl certificates in \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {

                        return networkManagementClient.applicationGateways.createOrUpdate(resourceGroup, gatewayName, applicationGateway, __cb(_, __frame, 58, 73, function ___(__0, __5) { applicationGateway = __5; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__1() {
        ...
        return cli.interaction.promptIfNotGiven($("gateway name : "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __2) { gatewayName = __2;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the application gateway \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
                ...
                sslCertificate = utils.findFirstCaseIgnore(applicationGateway.sslCertificates, { name: name });
                index = utils.indexOfCaseIgnore(applicationGateway.sslCertificates, { name: name });
                if (!sslCertificate) {
                  return _(new Error(util.format($("ssl certificates with name \"%s\" not found in the \"%s\""), name, gatewayName))); } ;
                ...
                if (options.certPassword) {
                  parameters.sslCertificates[index].password = options.certPassword; } ; return (function __$__2(__then) {


                  if (options.certFile) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {

                          data = fs.readFileSync(options.certFile);
                          parameters.sslCertificates[index].data = data.toString("base64"); __then(); }); })(function ___(err, __result) { __catch(function __$__2() { if (err) {
                  ...
                  generatorUtils.removeEmptyObjects(parameters);
                  progress = cli.interaction.progress(util.format($("Updating ssl certificates in \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {

                        return networkManagementClient.applicationGateways.createOrUpdate(resourceGroup, gatewayName, applicationGateway, __cb(_, __frame, 56, 73, function ___(__0, __5) { applicationGateway = __5; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__2() {
        ...
        return cli.interaction.promptIfNotGiven($("gateway name : "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __3) { gatewayName = __3;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __4) { name = __4;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the application gateway \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
                ...
                index = utils.indexOfCaseIgnore(applicationGateway.sslCertificates, { name: name });
                if ((index === -1)) {
                  return _(new Error(util.format($("ssl certificates \"%s\" not found in the gatewayName \"%s\""), name, applicationGateway.name))); } ; return (function __$__3(_) {


                  var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete ssl certificates with name \"%s\" from \"%s\"? [y/n] "), name, gatewayName), __cb(_, __frame, 31, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -200, 17, function ___(__0, __6) { return (function __$__3(__then) { if (__6) { return _(null); } else { __then(); } ; })(function __$__3() {



                    applicationGateway.sslCertificates.splice(index, 1);
                    progress = cli.interaction.progress("Deleting ssl certificates"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
  ...
  sslCertificates.command("list [resource-group] [gateway-name]").description($("List ssl certificates")).usage("[options] <resource-group> <gateway-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --gateway-name <gateway-name>", $("the gateway name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(resourceGroup, gatewayName, options, _) { var subscription, networkManagementClient, applicationGateway, progress, items; var __frame = { name: "__5", line: 294 }; return __func(_, this, arguments, __5, 3, __frame, function __$__5() {
      ...
      progress = cli.interaction.progress(util.format($("Looking up the application gateway \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__5() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__5() {
          ...
          items = applicationGateway.sslCertificates;
