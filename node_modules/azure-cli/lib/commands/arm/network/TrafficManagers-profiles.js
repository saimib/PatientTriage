...
exports.init = function(cli) {
  ...
  profiles.command("create [resource-group] [name] [relative-dns-name]").description($("Create a profile")).usage("[options] <resource-group> <name> <relative-dns-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the profile")).option("-u, --profile-status [profile-status]", $(("sets the status of the Traffic Manager" + "\n     profile.  Possible values are 'Enabled' and 'Disabled'"))).option("-m, --traffic-routing-method [traffic-routing-method]", $((("sets the traffic routing method of the" + "\n     Traffic Manager profile.  Possible values are 'Performance', 'Weighted',") + "\n     'Priority' or 'Geographic'"))).option("-r, --relative-dns-name <relative-dns-name>", $(((("sets the relative DNS name provided by" + "\n     this Traffic Manager profile.  This value is combined with the DNS domain name") + "\n     used by Azure Traffic Manager to form the fully-qualified domain name (FQDN) of") + "\n     the profile"))).option("-l, --ttl [ttl]", $((("sets the DNS Time-To-Live (TTL), in" + "\n     seconds.  This informs the local DNS resolvers and DNS clients how long to") + "\n     cache DNS responses provided by this Traffic Manager profile"))).option("-p, --monitor-protocol [monitor-protocol]", $(("sets the protocol (HTTP, HTTPS or TCP)" + "\n     used to probe for endpoint health"))).option("-o, --monitor-port [monitor-port]", $(("sets the TCP port used to probe for" + "\n     endpoint health"))).option("-a, --monitor-path [monitor-path]", $(("sets the path relative to the endpoint" + "\n     domain name used to probe for endpoint health"))).option("-e, --interval-in-seconds [interval-in-seconds]", $((("sets the monitor interval for endpoints" + "\n     in this profile. This is the interval at which Traffic Manager will check the") + "\n     health of each endpoint in this profile"))).option("-i, --timeout-in-seconds [timeout-in-seconds]", $((("sets the monitor timeout for endpoints" + "\n     in this profile. This is the time that Traffic Manager allows endpoints in this") + "\n     profile to response to the health check"))).option("-f, --tolerated-number-of-failures [tolerated-number-of-failures]", $((("sets the number of consecutive failed" + "\n     health check that Traffic Manager tolerates before declaring an endpoint in") + "\n     this profile Degraded after the next failed health check"))).option("-t, --tags [tags]", $(constants.help.tags.create)).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __1(resourceGroup, name, relativeDnsName, options, _) { var useDefaults, subscription, trafficManagerManagementClient, profileResultVar, progress, parameters; var __frame = { name: "__1", line: 86 }; return __func(_, this, arguments, __1, 4, __frame, function __$__1() {
          ...
          return cli.interaction.promptIfNotGiven($("relative dns name : "), relativeDnsName, __cb(_, __frame, 4, 48, function ___(__0, __3) { options.relativeDnsName = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the profile \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                ...
                if (options.profileStatus) {
                  parameters.profileStatus = options.profileStatus; } else {
                  if (useDefaults) {
                    parameters.profileStatus = defaultProfileStatus; } ; } ;


                if (options.trafficRoutingMethod) {
                  parameters.trafficRoutingMethod = options.trafficRoutingMethod; } else {
                  if (useDefaults) {
                ...
                if (options.monitorProtocol) {
                  parameters.monitorConfig.protocol = options.monitorProtocol; } else {
                  if (useDefaults) {
  ...
  profiles.command("set [resource-group] [name]").description($("Update a profile")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the profile")).option("-u, --profile-status [profile-status]", $(("sets the status of the Traffic Manager" + "\n     profile.  Possible values are 'Enabled' and 'Disabled'"))).option("-m, --traffic-routing-method [traffic-routing-method]", $((("sets the traffic routing method of the" + "\n     Traffic Manager profile.  Possible values are 'Performance', 'Weighted',") + "\n     'Priority' or 'Geographic'"))).option("-r, --relative-dns-name [relative-dns-name]", $(((("sets the relative DNS name provided by" + "\n     this Traffic Manager profile.  This value is combined with the DNS domain name") + "\n     used by Azure Traffic Manager to form the fully-qualified domain name (FQDN) of") + "\n     the profile"))).option("-l, --ttl [ttl]", $((("sets the DNS Time-To-Live (TTL), in" + "\n     seconds.  This informs the local DNS resolvers and DNS clients how long to") + "\n     cache DNS responses provided by this Traffic Manager profile"))).option("-p, --monitor-protocol [monitor-protocol]", $(("sets the protocol (HTTP, HTTPS or TCP)" + "\n     used to probe for endpoint health"))).option("-o, --monitor-port [monitor-port]", $(("sets the TCP port used to probe for" + "\n     endpoint health"))).option("-a, --monitor-path [monitor-path]", $(("sets the path relative to the endpoint" + "\n     domain name used to probe for endpoint health"))).option("-e, --interval-in-seconds [interval-in-seconds]", $((("sets the monitor interval for endpoints" + "\n     in this profile. This is the interval at which Traffic Manager will check the") + "\n     health of each endpoint in this profile"))).option("-i, --timeout-in-seconds [timeout-in-seconds]", $((("sets the monitor timeout for endpoints" + "\n     in this profile. This is the time that Traffic Manager allows endpoints in this") + "\n     profile to response to the health check"))).option("-f, --tolerated-number-of-failures [tolerated-number-of-failures]", $((("sets the number of consecutive failed" + "\n     health check that Traffic Manager tolerates before declaring an endpoint in") + "\n     this profile Degraded after the next failed health check"))).option("-t, --tags [tags]", $(constants.help.tags.create)).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, name, options, _) { var useDefaults, subscription, trafficManagerManagementClient, profileResultVar, progress, parameters; var __frame = { name: "__2", line: 227 }; return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
        ...
        return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 2, 29, function ___(__0, __3) { name = __3;
          ...
          progress = cli.interaction.progress(util.format($("Looking up the profile \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
              ...
              if (!profileResultVar) {
                ...
                var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete profile \"%s\"? [y/n] "), name), __cb(_, __frame, 25, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -337, 17, function ___(__0, __5) { return (function __$__3(__then) { if (__5) {
  ...
  profiles.command("is-dns-available [relative-dns-name]").description($("Perform check traffic manager relative dns name availability operation on a profile")).usage("[options] <relative-dns-name>").option("-r, --relative-dns-name <relative-dns-name>", $("sets the name of the resource")).option("-y, --type [type]", $("sets the type of the resource")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __6(relativeDnsName, options, _) { var useDefaults, subscription, trafficManagerManagementClient, profileResultVar, parameters, progress; var __frame = { name: "__6", line: 462 }; return __func(_, this, arguments, __6, 2, __frame, function __$__6() {
