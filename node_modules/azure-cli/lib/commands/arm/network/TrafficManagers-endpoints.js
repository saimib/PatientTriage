...
exports.init = function(cli) {
  ...
  endpoints.command("create [resource-group] [profile-name] [type] [name]").description($("Create an endpoint")).usage("[options] <resource-group> <profile-name> <type> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-f, --profile-name <profile-name>", $("the profile name")).option("-y, --type <type>", $("the type")).option("-n, --name <name>", $("the name of the endpoint")).option("-i, --target-resource-id [target-resource-id]", $(("sets the Azure Resource URI of the of" + "\n     the endpoint.  Not applicable to endpoints of type 'ExternalEndpoints'"))).option("-t, --target [target]", $((("sets the fully-qualified DNS name of" + "\n     the endpoint.  Traffic Manager returns this value in DNS responses to direct") + "\n     traffic to this endpoint"))).option("-u, --status [status]", $((("sets the status of the endpoint..  If" + "\n     the endpoint is Enabled, it is probed for endpoint health and is included in") + "\n     the traffic routing method.  Possible values are 'Enabled' and 'Disabled'"))).option("-w, --weight [weight]", $((("sets the weight of this endpoint when" + "\n     using the 'Weighted' traffic routing method. Possible values are from 1 to") + "\n     1000"))).option("-p, --priority [priority]", $((((("sets the priority of this endpoint when" + "\n     using the 'Priority' traffic routing method. Possible values are from 1 to") + "\n     1000, lower values represent higher priority. This is an optional parameter.") + "\n     If specified, it must be specified on all endpoints, and no two endpoints can") + "\n     share the same priority value"))).option("-l, --location [location]", $(("specifies the location of the external" + "\n     or nested endpoints when using the 'Performance' traffic routing method"))).option("-c, --min-child-endpoints [min-child-endpoints]", $(((("sets the minimum number of endpoints" + "\n     that must be available in the child profile in order for the parent profile to") + "\n     be considered available. Only applicable to endpoint of type") + "\n     'NestedEndpoints'"))).option("-m, --geo-mapping [geo-mapping]", $(((("sets the list of countries/regions" + "\n     mapped to this endpoint when using the 'Geographic' traffic routing method.") + "\n     Please consult Traffic Manager Geographic documentation for a full list of") + "\n     accepted values"))).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __1(resourceGroup, profileName, type, name, options, _) { var subscription, trafficManagerManagementClient, endpoint, progress, parameters; var __frame = { name: "__1", line: 73 }; return __func(_, this, arguments, __1, 5, __frame, function __$__1() {
  ...
  endpoints.command("set [resource-group] [profile-name] [type] [name]").description($("Update an endpoint")).usage("[options] <resource-group> <profile-name> <type> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-f, --profile-name <profile-name>", $("the profile name")).option("-y, --type <type>", $("the type")).option("-n, --name <name>", $("the name of the endpoint")).option("-i, --target-resource-id [target-resource-id]", $(("sets the Azure Resource URI of the of" + "\n     the endpoint.  Not applicable to endpoints of type 'ExternalEndpoints'"))).option("-t, --target [target]", $((("sets the fully-qualified DNS name of" + "\n     the endpoint.  Traffic Manager returns this value in DNS responses to direct") + "\n     traffic to this endpoint"))).option("-u, --status [status]", $((("sets the status of the endpoint..  If" + "\n     the endpoint is Enabled, it is probed for endpoint health and is included in") + "\n     the traffic routing method.  Possible values are 'Enabled' and 'Disabled'"))).option("-w, --weight [weight]", $((("sets the weight of this endpoint when" + "\n     using the 'Weighted' traffic routing method. Possible values are from 1 to") + "\n     1000"))).option("-p, --priority [priority]", $((((("sets the priority of this endpoint when" + "\n     using the 'Priority' traffic routing method. Possible values are from 1 to") + "\n     1000, lower values represent higher priority. This is an optional parameter.") + "\n     If specified, it must be specified on all endpoints, and no two endpoints can") + "\n     share the same priority value"))).option("-l, --location [location]", $(("specifies the location of the external" + "\n     or nested endpoints when using the 'Performance' traffic routing method"))).option("-c, --min-child-endpoints [min-child-endpoints]", $(((("sets the minimum number of endpoints" + "\n     that must be available in the child profile in order for the parent profile to") + "\n     be considered available. Only applicable to endpoint of type") + "\n     'NestedEndpoints'"))).option("-m, --geo-mapping [geo-mapping]", $(((("sets the list of countries/regions" + "\n     mapped to this endpoint when using the 'Geographic' traffic routing method.") + "\n     Please consult Traffic Manager Geographic documentation for a full list of") + "\n     accepted values"))).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, profileName, type, name, options, _) { var subscription, trafficManagerManagementClient, endpoint, progress, parameters; var __frame = { name: "__2", line: 178 }; return __func(_, this, arguments, __2, 5, __frame, function __$__2() {
            ...
            return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 4, 29, function ___(__0, __5) { name = __5;
              ...
              progress = cli.interaction.progress(util.format($("Looking up the endpoint \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
                  ...
                  if (!endpoint) {
                    ...
                    var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete endpoint \"%s\"? [y/n] "), name), __cb(_, __frame, 27, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -257, 17, function ___(__0, __7) { return (function __$__3(__then) { if (__7) {
  ...
  endpoints.command("show [resource-group] [profile-name] [type] [name]").description($("Show an endpoint")).usage("[options] <resource-group> <profile-name> <type> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-f, --profile-name <profile-name>", $("the profile name")).option("-y, --type <type>", $("the type")).option("-n, --name <name>", $("the name of the endpoint")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, profileName, type, name, options, _) { var subscription, trafficManagerManagementClient, endpoint, progress; var __frame = { name: "__4", line: 307 }; return __func(_, this, arguments, __4, 5, __frame, function __$__4() {
