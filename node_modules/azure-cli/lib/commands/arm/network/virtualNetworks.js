...
exports.init = function(cli) {
  ...
  virtualNetworks.command("create [resource-group] [name] [location]").description($("Create a virtual network")).usage("[options] <resource-group> <name> <location>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the virtual network")).option("-l, --location <location>", $("the location")).option("-a, --address-prefixes [address-prefixes]", $(("a list of address blocks reserved for" + "\n     this virtual network in CIDR notation"))).option("-d, --dns-servers [dns-servers]", $("the list of DNS servers IP addresses")).option("-t, --tags [tags]", $(constants.help.tags.create)).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __1(resourceGroup, name, location, options, _) { var useDefaults, subscription, networkManagementClient, virtualNetwork, progress, parameters; var __frame = { name: "__1", line: 53 }; return __func(_, this, arguments, __1, 4, __frame, function __$__1() {
          ...
          return cli.interaction.promptIfNotGiven($("location : "), location, __cb(_, __frame, 4, 41, function ___(__0, __3) { options.location = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the virtual network \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                ...
                if (options.addressPrefixes) {
                  ...
                  parameters.addressSpace.addressPrefixes = parameters.addressSpace.addressPrefixes.concat(options.addressPrefixes.split(",")); } else {
                  if (useDefaults) {
                ...
                progress = cli.interaction.progress(util.format($("Creating virtual network \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                      ...
                      return networkManagementClient.virtualNetworks.createOrUpdate(resourceGroup, name, parameters, __cb(_, __frame, 57, 65, function ___(__0, __5) { virtualNetwork = __5; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__1() {
  ...
  virtualNetworks.command("set [resource-group] [name]").description($("Update a virtual network")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the virtual network")).option("-a, --address-prefixes [address-prefixes]", $(("a list of address blocks reserved for" + "\n     this virtual network in CIDR notation"))).option("-d, --dns-servers [dns-servers]", $("the list of DNS servers IP addresses")).option("-t, --tags [tags]", $(constants.help.tags.create)).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, name, options, _) { var useDefaults, subscription, networkManagementClient, virtualNetwork, progress, parameters; var __frame = { name: "__2", line: 128 }; return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
        ...
        return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __2) { name = __2;
          ...
          progress = cli.interaction.progress(util.format($("Looking up the virtual network \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
              ...
              progress = cli.interaction.progress(util.format($("Updating virtual network \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
                    ...
                    return networkManagementClient.virtualNetworks.createOrUpdate(resourceGroup, name, parameters, __cb(_, __frame, 64, 65, function ___(__0, __4) { virtualNetwork = __4; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__2() {
        ...
        return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 2, 29, function ___(__0, __3) { name = __3;
          ...
          progress = cli.interaction.progress(util.format($("Looking up the virtual network \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
              ...
              if (!virtualNetwork) {
                ...
                var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete virtual network \"%s\"? [y/n] "), name), __cb(_, __frame, 25, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -206, 17, function ___(__0, __5) { return (function __$__3(__then) { if (__5) {
  ...
  virtualNetworks.command("show [resource-group] [name]").description($("Show a virtual network")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the virtual network")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, name, options, _) { var subscription, networkManagementClient, virtualNetwork, progress; var __frame = { name: "__4", line: 252 }; return __func(_, this, arguments, __4, 3, __frame, function __$__4() {
  ...
  virtualNetworks.command("list [resource-group]").description($("List virtual networks")).usage("[options] <resource-group>").option("-g, --resource-group [resource-group]", $("the name of the resource group")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(resourceGroup, options, _) { var subscription, networkManagementClient, virtualNetwork, progress; var __frame = { name: "__5", line: 285 }; return __func(_, this, arguments, __5, 2, __frame, function __$__5() {
  ...
  virtualNetworks.command("usage [resource-group] [name]").description($("Perform list usage operation on a virtual network")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the virtual network")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __6(resourceGroup, name, options, _) { var subscription, networkManagementClient, virtualNetwork, progress, parameters; var __frame = { name: "__6", line: 331 }; return __func(_, this, arguments, __6, 3, __frame, function __$__6() {
        ...
        return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          ...
          progress = cli.interaction.progress(util.format($("Looking up the virtual network \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__6() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__6() {
              ...
              progress = cli.interaction.progress(util.format($("Performing list usage operation on a virtual network \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__6() {
                    ...
                    return networkManagementClient.virtualNetworks.listUsage(resourceGroup, name, __cb(_, __frame, 29, 65, function ___(__0, __4) { virtualNetwork = __4; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__6() {
