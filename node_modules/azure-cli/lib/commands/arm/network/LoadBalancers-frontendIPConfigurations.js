...
exports.init = function(cli) {
          ...
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                ...
                if (utils.findFirstCaseIgnore(loadBalancer.frontendIPConfigurations, { name: name })) {
                  return _(new Error(util.format($("frontend ip configurations with name \"%s\" already exists in the \"%s\""), name, lbName))); } ;
                ...
                if (!parameters.frontendIPConfigurations[index].subnet) {
                  parameters.frontendIPConfigurations[index].subnet = { }; } ; return (function __$__1(__then) {

                  if (options.subnetId) {
                    if (options.subnetName) {
                      cli.output.warn($("--subnet-name parameter will be ignored because --subnet-id and --subnet-name are mutually exclusive")); } ;

                    parameters.frontendIPConfigurations[index].subnet.id = options.subnetId; __then(); } else { return (function __$__1(__then) {
                      if (options.subnetName) {
                        return networkManagementClient.subnets.get(resourceGroup, options.subnetVnetName, options.subnetName, __cb(_, __frame, 54, 64, function ___(__0, __5) { idContainersubnet = __5;
                          parameters.frontendIPConfigurations[index].subnet.id = idContainersubnet.id; __then(); }, true)); } else { __then(); } ; })(__then); } ; })(function __$__1() {


                  if (!parameters.frontendIPConfigurations[index].publicIPAddress) {
                    parameters.frontendIPConfigurations[index].publicIPAddress = { }; } ; return (function __$__1(__then) {
                    ...
                    if (options.publicIpId) {
                      ...
                      parameters.frontendIPConfigurations[index].publicIPAddress.id = options.publicIpId; __then(); } else { return (function __$__1(__then) {
                        if (options.publicIpName) {
                          return networkManagementClient.publicIPAddresses.get(resourceGroup, options.publicIpName, __cb(_, __frame, 67, 83, function ___(__0, __6) { idContainerpublicIPAddress = __6;
                            parameters.frontendIPConfigurations[index].publicIPAddress.id = idContainerpublicIPAddress.id; __then(); }, true)); } else { __then(); } ; })(__then); } ; })(function __$__1() {
                    ...
                    progress = cli.interaction.progress(util.format($("Creating frontend ip configurations in \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                        ...
                        cli.interaction.formatOutput(loadBalancer.frontendIPConfigurations[generatorUtils.findIndexByKeyValue(loadBalancer.frontendIPConfigurations, "name", name)], generatorUtils.traverse); _(); }); }); }); }); }); }); }, true)); }, true)); }, true)); }); });


  frontendIPConfigurations.command("set [resource-group] [lb-name] [name]").description($("Update a frontend ip configurations")).usage("[options] <resource-group> <lb-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-l, --lb-name <lb-name>", $("the lb name")).option("-n, --name <name>", $("the name of the frontend ip configuration")).option("-a, --private-ip-address [private-ip-address]", $(("the private IP address of the IP" + "\n     configuration"))).option("-e, --subnet-name [subnet-name]", $(("sets subnet name. This option is" + "\n     mutually exclusive with --subnet-id"))).option("-m, --subnet-vnet-name [subnet-vnet-name]", $("name of the virtual network that contains subnet")).option("-b, --subnet-id [subnet-id]", $(("sets subnet id. This option is mutually" + "\n     exclusive with --subnet-name"))).option("-u, --public-ip-id [public-ip-id]", $(("sets public ip address id. This option" + "\n     is mutually exclusive with --public-ip-name"))).option("-i, --public-ip-name [public-ip-name]", $(("sets public ip address name. This" + "\n     option is mutually exclusive with --public-ip-id"))).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, lbName, name, options, _) { var subscription, networkManagementClient, loadBalancer, progress, frontendIPConfiguration, index, parameters, idContainersubnet, idContainerpublicIPAddress; var __frame = { name: "__2", line: 161 }; return __func(_, this, arguments, __2, 4, __frame, function __$__2() {
        ...
        return cli.interaction.promptIfNotGiven($("lb name : "), lbName, __cb(_, __frame, 2, 31, function ___(__0, __2) { lbName = __2;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
                ...
                frontendIPConfiguration = utils.findFirstCaseIgnore(loadBalancer.frontendIPConfigurations, { name: name });
                index = utils.indexOfCaseIgnore(loadBalancer.frontendIPConfigurations, { name: name });
                if (!frontendIPConfiguration) {
                  return _(new Error(util.format($("frontend ip configurations with name \"%s\" not found in the \"%s\""), name, lbName))); } ;
                ...
                if (!parameters.frontendIPConfigurations[index].subnet) {
                  parameters.frontendIPConfigurations[index].subnet = { }; } ; return (function __$__2(__then) {

                  if (options.subnetId) {
                    if (options.subnetName) {
                      cli.output.warn($("--subnet-name parameter will be ignored because --subnet-id and --subnet-name are mutually exclusive")); } ;

                    parameters.frontendIPConfigurations[index].subnet.id = options.subnetId; __then(); } else { return (function __$__2(__then) {
                      if (options.subnetName) {
                        return networkManagementClient.subnets.get(resourceGroup, options.subnetVnetName, options.subnetName, __cb(_, __frame, 60, 64, function ___(__0, __5) { idContainersubnet = __5;
                          parameters.frontendIPConfigurations[index].subnet.id = idContainersubnet.id; __then(); }, true)); } else { __then(); } ; })(__then); } ; })(function __$__2() {


                  if (!parameters.frontendIPConfigurations[index].publicIPAddress) {
                    parameters.frontendIPConfigurations[index].publicIPAddress = { }; } ; return (function __$__2(__then) {

                    if (options.publicIpId) {
                      if (options.publicIpName) {
                        cli.output.warn($("--public-ip-name parameter will be ignored because --public-ip-id and --public-ip-name are mutually exclusive")); } ;

                      parameters.frontendIPConfigurations[index].publicIPAddress.id = options.publicIpId; __then(); } else { return (function __$__2(__then) {
                        if (options.publicIpName) {
                          return networkManagementClient.publicIPAddresses.get(resourceGroup, options.publicIpName, __cb(_, __frame, 73, 83, function ___(__0, __6) { idContainerpublicIPAddress = __6;
                            parameters.frontendIPConfigurations[index].publicIPAddress.id = idContainerpublicIPAddress.id; __then(); }, true)); } else { __then(); } ; })(__then); } ; })(function __$__2() {


                    generatorUtils.removeEmptyObjects(parameters);
                    progress = cli.interaction.progress(util.format($("Updating frontend ip configurations in \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {

                          return networkManagementClient.loadBalancers.createOrUpdate(resourceGroup, lbName, loadBalancer, __cb(_, __frame, 80, 61, function ___(__0, __7) { loadBalancer = __7; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__2() {

                            progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$__2() {

                        cli.interaction.formatOutput(loadBalancer.frontendIPConfigurations[index], generatorUtils.traverse); _(); }); }); }); }); }); }); }, true)); }, true)); }, true)); }); });


  frontendIPConfigurations.command("delete [resource-group] [lb-name] [name]").description($("Delete a frontend ip configurations")).usage("[options] <resource-group> <lb-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-l, --lb-name <lb-name>", $("the lb name")).option("-n, --name <name>", $("the name of the frontend ip configuration")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __3(resourceGroup, lbName, name, options, _) { var subscription, networkManagementClient, loadBalancer, progress, index; var __frame = { name: "__3", line: 256 }; return __func(_, this, arguments, __3, 4, __frame, function __$__3() {
        ...
        return cli.interaction.promptIfNotGiven($("lb name : "), lbName, __cb(_, __frame, 2, 31, function ___(__0, __3) { lbName = __3;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __4) { name = __4;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
                ...
                index = utils.indexOfCaseIgnore(loadBalancer.frontendIPConfigurations, { name: name });
                if ((index === -1)) {
                  return _(new Error(util.format($("frontend ip configurations \"%s\" not found in the lbName \"%s\""), name, loadBalancer.name))); } ; return (function __$__3(_) {


                  var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete frontend ip configurations with name \"%s\" from \"%s\"? [y/n] "), name, lbName), __cb(_, __frame, 31, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -255, 17, function ___(__0, __6) { return (function __$__3(__then) { if (__6) { return _(null); } else { __then(); } ; })(function __$__3() {



                    loadBalancer.frontendIPConfigurations.splice(index, 1);
                    progress = cli.interaction.progress("Deleting frontend ip configurations"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
  ...
  frontendIPConfigurations.command("show [resource-group] [lb-name] [name]").description($("Show a frontend ip configurations")).usage("[options] <resource-group> <lb-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-l, --lb-name <lb-name>", $("the lb name")).option("-n, --name <name>", $("the name of the frontend ip configuration")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, lbName, name, options, _) { var subscription, networkManagementClient, loadBalancer, progress, frontendIPConfiguration; var __frame = { name: "__4", line: 307 }; return __func(_, this, arguments, __4, 4, __frame, function __$__4() {
  ...
  frontendIPConfigurations.command("list [resource-group] [lb-name]").description($("List frontend ip configurations")).usage("[options] <resource-group> <lb-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-l, --lb-name <lb-name>", $("the lb name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(resourceGroup, lbName, options, _) { var subscription, networkManagementClient, loadBalancer, progress, items; var __frame = { name: "__5", line: 347 }; return __func(_, this, arguments, __5, 3, __frame, function __$__5() {
      ...
      progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), lbName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__5() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__5() {
          ...
          items = loadBalancer.frontendIPConfigurations;
