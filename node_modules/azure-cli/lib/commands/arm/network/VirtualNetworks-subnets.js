...
exports.init = function(cli) {
                  ...
                  if (!parameters.networkSecurityGroup) {
                    ...
                    if (!parameters.routeTable) {
                      ...
                      progress = cli.interaction.progress(util.format($("Creating subnet \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                            ...
                            return networkManagementClient.subnets.createOrUpdate(resourceGroup, vnetName, name, parameters, __cb(_, __frame, 61, 49, function ___(__0, __8) { subnet = __8; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__1() {
  ...
  subnets.command("set [resource-group] [vnet-name] [name]").description($("Update a subnet")).usage("[options] <resource-group> <vnet-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-e, --vnet-name <vnet-name>", $("the vnet name")).option("-n, --name <name>", $("the name of the subnet")).option("-a, --address-prefix [address-prefix]", $("the address prefix for the subnet")).option("-w, --network-security-group-id [network-security-group-id]", $(("sets network security group id. This" + "\n     option is mutually exclusive with --network-security-group-name"))).option("-o, --network-security-group-name [network-security-group-name]", $(("sets network security group name. This" + "\n     option is mutually exclusive with --network-security-group-id"))).option("-i, --route-table-id [route-table-id]", $(("sets route table id. This option is" + "\n     mutually exclusive with --route-table-name"))).option("-r, --route-table-name [route-table-name]", $(("sets route table name. This option is" + "\n     mutually exclusive with --route-table-id"))).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, vnetName, name, options, _) { var subscription, networkManagementClient, subnet, progress, parameters, idContainernetworkSecurityGroup, idContainerrouteTable; var __frame = { name: "__2", line: 141 }; return __func(_, this, arguments, __2, 4, __frame, function __$__2() {
                ...
                if (!parameters.networkSecurityGroup) {
                  ...
                  if (!parameters.routeTable) {
                    ...
                    progress = cli.interaction.progress(util.format($("Updating subnet \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
                          ...
                          return networkManagementClient.subnets.createOrUpdate(resourceGroup, vnetName, name, parameters, __cb(_, __frame, 76, 49, function ___(__0, __7) { subnet = __7; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__2() {
          ...
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __4) { name = __4;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the subnet \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
                ...
                if (!subnet) {
                  ...
                  var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete subnet \"%s\"? [y/n] "), name), __cb(_, __frame, 26, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -232, 17, function ___(__0, __6) { return (function __$__3(__then) { if (__6) {
  ...
  subnets.command("show [resource-group] [vnet-name] [name]").description($("Show a subnet")).usage("[options] <resource-group> <vnet-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-e, --vnet-name <vnet-name>", $("the vnet name")).option("-n, --name <name>", $("the name of the subnet")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, vnetName, name, options, _) { var subscription, networkManagementClient, subnet, progress; var __frame = { name: "__4", line: 280 }; return __func(_, this, arguments, __4, 4, __frame, function __$__4() {
  ...
  subnets.command("list [resource-group] [vnet-name]").description($("List subnet")).usage("[options] <resource-group> <vnet-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-e, --vnet-name <vnet-name>", $("the vnet name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(resourceGroup, vnetName, options, _) { var subscription, networkManagementClient, subnet, progress; var __frame = { name: "__5", line: 315 }; return __func(_, this, arguments, __5, 3, __frame, function __$__5() {
