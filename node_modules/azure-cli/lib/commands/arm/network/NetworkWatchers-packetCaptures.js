...
exports.init = function(cli) {
          ...
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            return cli.interaction.promptIfNotGiven($("target : "), target, __cb(_, __frame, 4, 39, function ___(__0, __4) { options.target = __4;
              ...
              progress = cli.interaction.progress(util.format($("Looking up the packet capture \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                          ...
                          return networkManagementClient.packetCaptures.get(resourceGroup, watcherName, name, null, __cb(_, __frame, 13, 56, function ___(__0, __5) { result = __5; __then(); }, true)); }); })(function ___(e, __result) { __catch(function __$__1() { if (e) {
                  ...
                  if (options.localFilePath) {
                    ...
                    if (options.filtersFile) { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                      ...
                      progress = cli.interaction.progress(util.format($("Creating packet capture \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                            ...
                            return networkManagementClient.packetCaptures.create(resourceGroup, watcherName, name, parameters, __cb(_, __frame, 74, 56, function ___(__0, __6) { result = __6; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__1() {

                              progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$__1() {

                          cli.interaction.formatOutput(result, generatorUtils.traverse); _(); }); }); }); }); }); }); }, true)); }, true)); }, true)); }, true)); }); });


  packetCaptures.command("delete [resource-group] [watcher-name] [name]").description($("Delete a packet capture")).usage("[options] <resource-group> <watcher-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --watcher-name <watcher-name>", $("the watcher name")).option("-n, --name <name>", $("the name of the packet capture")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, watcherName, name, options, _) { var subscription, networkManagementClient, result, progress; var __frame = { name: "__2", line: 166 }; return __func(_, this, arguments, __2, 4, __frame, function __$__2() {
        ...
        return cli.interaction.promptIfNotGiven($("watcher name : "), watcherName, __cb(_, __frame, 2, 36, function ___(__0, __3) { watcherName = __3;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __4) { name = __4;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the packet capture \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
                        ...
                        return networkManagementClient.packetCaptures.get(resourceGroup, watcherName, name, null, __cb(_, __frame, 11, 56, function ___(__0, __5) { result = __5; __then(); }, true)); }); })(function ___(e, __result) { __catch(function __$__2() { if (e) {
                ...
                if (!result) {
                  ...
                  var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete packet capture \"%s\"? [y/n] "), name), __cb(_, __frame, 24, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -165, 17, function ___(__0, __6) { return (function __$__2(__then) { if (__6) {
                    ...
                    progress = cli.interaction.progress(util.format($("Deleting packet capture \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
                          ...
                          return networkManagementClient.packetCaptures.deleteMethod(resourceGroup, watcherName, name, __cb(_, __frame, 31, 56, function ___(__0, __7) { result = __7;
  ...
  packetCaptures.command("show [resource-group] [watcher-name] [name]").description($("Show a packet capture")).usage("[options] <resource-group> <watcher-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --watcher-name <watcher-name>", $("the watcher name")).option("-n, --name <name>", $("the name of the packet capture")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __3(resourceGroup, watcherName, name, options, _) { var subscription, networkManagementClient, result, progress; var __frame = { name: "__3", line: 211 }; return __func(_, this, arguments, __3, 4, __frame, function __$__3() {
        ...
        return cli.interaction.promptIfNotGiven($("watcher name : "), watcherName, __cb(_, __frame, 2, 36, function ___(__0, __2) { watcherName = __2;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the packet capture \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
                        ...
                        return networkManagementClient.packetCaptures.get(resourceGroup, watcherName, name, null, __cb(_, __frame, 11, 56, function ___(__0, __4) { result = __4; __then(); }, true)); }); })(function ___(e, __result) { __catch(function __$__3() { if (e) {
  ...
  packetCaptures.command("status [resource-group] [watcher-name] [name]").description($("Perform get status operation on a packet capture")).usage("[options] <resource-group> <watcher-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --watcher-name <watcher-name>", $("the watcher name")).option("-n, --name <name>", $("the name of the packet capture")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, watcherName, name, options, _) { var subscription, networkManagementClient, result, progress, parameters; var __frame = { name: "__4", line: 245 }; return __func(_, this, arguments, __4, 4, __frame, function __$__4() {
      ...
      return cli.interaction.promptIfNotGiven($("resource group : "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("watcher name : "), watcherName, __cb(_, __frame, 2, 36, function ___(__0, __2) { watcherName = __2;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the packet capture \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__4() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__4() {

                        return networkManagementClient.packetCaptures.get(resourceGroup, watcherName, name, null, __cb(_, __frame, 12, 56, function ___(__0, __4) { result = __4; __then(); }, true)); }); })(function ___(e, __result) { __catch(function __$__4() { if (e) {
                ...
                generatorUtils.removeEmptyObjects(parameters);
                progress = cli.interaction.progress(util.format($("Performing get status operation on a packet capture \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__4() {

                      return networkManagementClient.packetCaptures.getStatus(resourceGroup, watcherName, name, __cb(_, __frame, 30, 56, function ___(__0, __5) { result = __5; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__4() {
  ...
  packetCaptures.command("list [resource-group] [watcher-name]").description($("List packet captures")).usage("[options] <resource-group> <watcher-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --watcher-name <watcher-name>", $("the watcher name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(resourceGroup, watcherName, options, _) { var subscription, networkManagementClient, result, progress; var __frame = { name: "__5", line: 288 }; return __func(_, this, arguments, __5, 3, __frame, function __$__5() {
      ...
      result = null; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__5() { return (function __$__5(__then) {
              ...
              if ((typeof networkManagementClient.packetCaptures.listAll != "function")) {
                return cli.interaction.promptIfNotGiven($("resource-group : "), resourceGroup, __cb(_, __frame, 10, 42, function ___(__0, __1) { resourceGroup = __1;
                  return cli.interaction.promptIfNotGiven($("network watcher : "), watcherName, __cb(_, __frame, 11, 40, function ___(__0, __2) { watcherName = __2;
                    progress = cli.interaction.progress($("Getting the packet captures"));
                    return networkManagementClient.packetCaptures.list(resourceGroup, watcherName, __cb(_, __frame, 13, 58, function ___(__0, __3) { result = __3; __then(); }, true)); }, true)); }, true)); } else { return (function __$__5(__then) {

                  if (options.resourceGroup) {
                    return cli.interaction.promptIfNotGiven($("network watcher : "), watcherName, __cb(_, __frame, 16, 42, function ___(__0, __4) { watcherName = __4;
                      progress = cli.interaction.progress($("Getting the packet captures"));
                      return networkManagementClient.packetCaptures.list(resourceGroup, watcherName, __cb(_, __frame, 18, 60, function ___(__0, __5) { result = __5; __then(); }, true)); }, true)); } else {

                    return cli.interaction.promptIfNotGiven($("network watcher : "), watcherName, __cb(_, __frame, 20, 42, function ___(__0, __6) { watcherName = __6;
                      progress = cli.interaction.progress($("Getting the packet captures"));
                      return networkManagementClient.packetCaptures.listAll(watcherName, __cb(_, __frame, 22, 60, function ___(__0, __7) { result = __7; __then(); }, true)); }, true)); } ; })(__then); } ; })(function __$__5() { _(null, null, true); }); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__5() {
  ...
  packetCaptures.command("stop [resource-group] [watcher-name] [name]").description($("Perform stop operation on a packet capture")).usage("[options] <resource-group> <watcher-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --watcher-name <watcher-name>", $("the watcher name")).option("-n, --name <name>", $("the name of the packet capture")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __6(resourceGroup, watcherName, name, options, _) { var subscription, networkManagementClient, result, progress, parameters; var __frame = { name: "__6", line: 336 }; return __func(_, this, arguments, __6, 4, __frame, function __$__6() {
        ...
        return cli.interaction.promptIfNotGiven($("watcher name : "), watcherName, __cb(_, __frame, 2, 36, function ___(__0, __2) { watcherName = __2;
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the packet capture \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__6() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__6() {
                        ...
                        return networkManagementClient.packetCaptures.get(resourceGroup, watcherName, name, null, __cb(_, __frame, 12, 56, function ___(__0, __4) { result = __4; __then(); }, true)); }); })(function ___(e, __result) { __catch(function __$__6() { if (e) {
                ...
                progress = cli.interaction.progress(util.format($("Performing stop operation on a packet capture \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__6() {
                      ...
                      return networkManagementClient.packetCaptures.stop(resourceGroup, watcherName, name, __cb(_, __frame, 30, 56, function ___(__0, __5) { result = __5; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__6() {
