...
exports.init = function(cli) {
  ...
  localNetworkGateways.command("set [resource-group] [name]").description($("Update a local network gateway")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the local network gateway")).option("-a, --address-space [address-space]", $(("a list of address blocks reserved for" + "\n     this virtual network in CIDR notation"))).option("-i, --ip-address [ip-address]", $("IP address of local network gateway")).option("-j, --asn [asn]", $("the BGP speaker's ASN")).option("-b, --bgp-peering-address [bgp-peering-address]", $(("the BGP peering address and BGP" + "\n     identifier of this BGP speaker"))).option("-w, --peer-weight [peer-weight]", $(("the weight added to routes learned from" + "\n     this BGP speaker"))).option("-t, --tags [tags]", $(constants.help.tags.create)).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, name, options, _) { var subscription, networkManagementClient, localNetworkGateway, progress, parameters; var __frame = { name: "__2", line: 145 }; return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
        ...
        return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 2, 29, function ___(__0, __3) { name = __3;
          ...
          progress = cli.interaction.progress(util.format($("Looking up the local network gateway \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
              ...
              if (!localNetworkGateway) {
                ...
                var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete local network gateway \"%s\"? [y/n] "), name), __cb(_, __frame, 25, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -227, 17, function ___(__0, __5) { return (function __$__3(__then) { if (__5) {
  ...
  localNetworkGateways.command("show [resource-group] [name]").description($("Show a local network gateway")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the local network gateway")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, name, options, _) { var subscription, networkManagementClient, localNetworkGateway, progress; var __frame = { name: "__4", line: 273 }; return __func(_, this, arguments, __4, 3, __frame, function __$__4() {
  ...
  localNetworkGateways.command("list [resource-group]").description($("List local network gateways")).usage("[options] <resource-group>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(resourceGroup, options, _) { var subscription, networkManagementClient, localNetworkGateway, progress; var __frame = { name: "__5", line: 306 }; return __func(_, this, arguments, __5, 2, __frame, function __$__5() {
