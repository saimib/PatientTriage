...
__.extend(PublicIp.prototype, {
  get: function get__1(resourceGroupName, publicIpName, _) { var self, progress, publicIP, __this = this; var __frame = { name: "get__1", line: 27 }; return __func(_, this, arguments, get__1, 2, __frame, function __$get__1() { self = __this;

      progress = self.interaction.progress(util.format($("Looking up the public ip \"%s\""), publicIpName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$get__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$get__1() {
