...
exports.init = function(cli) {
  ...
  usage.command("list [location]").description($("List usage of network resources.")).usage("[options] <location>").option("-l, --location <location>", $("the location")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __1(location, options, _) { var networkManagementClient, networkUsage; var __frame = { name: "__1", line: 41 }; return __func(_, this, arguments, __1, 2, __frame, function __$__1() {





      return cli.interaction.promptIfNotGiven($("Location: "), location, __cb(_, __frame, 1, 33, function ___(__0, __1) { location = __1;
        ...
        return networkUsage.list(location, options, __cb(_, __frame, 5, 19, function __$__1() { _(); }, true)); }, true)); }); });


  var nic = network.category("nic").description($("Commands to manage network interfaces"));


  nic.command("list [resource-group]").description($("Get all network interfaces")).usage("[options] [resource-group]").option("-g, --resource-group [resource-group]", $("the name of the resource group")).option("-m, --virtual-machine-scale-set-name [virtual-machine-scale-set-name]", $("the name of the virtual machine scale set")).option("-i, --virtual-machine-index [virtual-machine-index]", $("the index of the virtual machine in scale set")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, options, _) { var networkManagementClient, nic; var __frame = { name: "__2", line: 59 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
      ...
      return nic.list(options, __cb(_, __frame, 4, 10, function __$__2() { _(); }, true)); }); });


  nic.command("show [resource-group] [name]").description($("Get a network interface")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the network interface")).option("-m, --virtual-machine-scale-set-name [virtual-machine-scale-set-name]", $("the name of the virtual machine scale set")).option("-i, --virtual-machine-index [virtual-machine-index]", $("the index of virtual machine in scale set")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __3(resourceGroup, name, options, _) { var networkManagementClient, nic; var __frame = { name: "__3", line: 74 }; return __func(_, this, arguments, __3, 3, __frame, function __$__3() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Network interface name: "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          ...
          networkManagementClient = getNetworkManagementClient(options);
          nic = new Nic(cli, networkManagementClient);
          return nic.show(resourceGroup, name, options, __cb(_, __frame, 6, 10, function __$__3() { _(); }, true)); }, true)); }, true)); }); });
  ...
  nicAddressPool.command("create [resource-group] [nic-name] [ip-config-name]").description($("Add a backend address pool to a NIC ip configuration")).usage("[options] <resource-group> <nic-name> <ip-config-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-c, --nic-name <nic-name>", $("the name of the network interface")).option("-n, --ip-config-name <ip-config-name>", $("the name of ip configuration")).option("-i, --lb-address-pool-id [lb-address-pool-id]", util.format($(("the load balancer backend address pool identifier" + "\n   e.g. %s")), constants.help.id.lbAddressPool)).option("-l, --lb-name [lb-name]", $(("the load balancer name." + "\n   This load balancer must exists in the same resource group as the NIC."))).option("-a, --lb-address-pool-name [lb-address-pool-name]", $(("the name of the address pool that exists in the load balancer" + "\n   Please use --lb-address-pool-id if that is not the case."))).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, nicName, ipConfigName, options, _) { var networkManagementClient, nic; var __frame = { name: "__4", line: 102 }; return __func(_, this, arguments, __4, 4, __frame, function __$__4() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Network interface name: "), nicName, __cb(_, __frame, 2, 32, function ___(__0, __2) { nicName = __2;
          ...
          networkManagementClient = getNetworkManagementClient(options);
          nic = new Nic(cli, networkManagementClient);
          return nic.createBackendAddressPool(resourceGroup, nicName, ipConfigName, options, __cb(_, __frame, 7, 10, function __$__4() { _(); }, true)); }, true)); }, true)); }); });


  nicAddressPool.command("delete [resource-group] [nic-name] [ip-config-name]").description($("Delete a backend address pool from a NIC ip configuration")).usage("[options] <resource-group> <nic-name> <ip-config-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-c, --nic-name <nic-name>", $("the name of the network interface")).option("-n, --ip-config-name <ip-config-name>", $("the name of ip configuration")).option("-i, --lb-address-pool-id [lb-address-pool-id]", util.format($(("the load balancer backend address pool identifier" + "\n   e.g. %s")), constants.help.id.lbAddressPool)).option("-l, --lb-name [lb-name]", $(("the load balancer name." + "\n   This load balancer must exists in the same resource group as the NIC."))).option("-a, --lb-address-pool-name [lb-address-pool-name]", $(("the name of the address pool that exists in the load balancer" + "\n   Please use --lb-address-pool-id if that is not the case."))).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(resourceGroup, nicName, ipConfigName, options, _) { var networkManagementClient, nic; var __frame = { name: "__5", line: 125 }; return __func(_, this, arguments, __5, 4, __frame, function __$__5() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Network interface name: "), nicName, __cb(_, __frame, 2, 32, function ___(__0, __2) { nicName = __2;
          ...
          networkManagementClient = getNetworkManagementClient(options);
          nic = new Nic(cli, networkManagementClient);
          return nic.deleteBackendAddressPool(resourceGroup, nicName, ipConfigName, options, __cb(_, __frame, 7, 10, function __$__5() { _(); }, true)); }, true)); }, true)); }); });
  ...
  nicInboundRule.command("create [resource-group] [nic-name] [ip-config-name]").description($("Add an inbound NAT rule to a NIC ip configuration")).usage("[options] <resource-group> <nic-name> <ip-config-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-c, --nic-name <nic-name>", $("the name of the network interface")).option("-n, --ip-config-name <ip-config-name>", $("the name of ip configuration")).option("-i, --lb-inbound-nat-rule-id [lb-inbound-nat-rule-id]", util.format($(("the inbound NAT rule identifier." + "\n   e.g. %s")), constants.help.id.lbInboundNatRule)).option("-l, --lb-name [lb-name]", $(("the load balancer name." + "\n   This load balancer must exists in the same resource group as the NIC."))).option("-r, --lb-inbound-nat-rule-name [lb-inbound-nat-rule-name]", $(("the name of the inbound NAT rule that exists in the load balancer." + "\n   Please use --inbound-nat-rule-id if that is not the case."))).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __6(resourceGroup, nicName, ipConfigName, options, _) { var networkManagementClient, nic; var __frame = { name: "__6", line: 151 }; return __func(_, this, arguments, __6, 4, __frame, function __$__6() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Network interface name: "), nicName, __cb(_, __frame, 2, 32, function ___(__0, __2) { nicName = __2;
          ...
          networkManagementClient = getNetworkManagementClient(options);
          nic = new Nic(cli, networkManagementClient);
          return nic.createInboundNatRule(resourceGroup, nicName, ipConfigName, options, __cb(_, __frame, 7, 10, function __$__6() { _(); }, true)); }, true)); }, true)); }); });


  nicInboundRule.command("delete [resource-group] [nic-name] [ip-config-name]").description($("Delete an inbound NAT rule from a NIC ip configuration")).usage("[options] <resource-group> <nic-name> <ip-config-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-c, --nic-name <nic-name>", $("the name of the network interface")).option("-n, --ip-config-name <ip-config-name>", $("the name of ip configuration")).option("-i, --lb-inbound-nat-rule-id [lb-inbound-nat-rule-id]", util.format($(("the inbound NAT rule identifier." + "\n   e.g. %s")), constants.help.id.lbInboundNatRule)).option("-l, --lb-name [lb-name]", $(("the load balancer name." + "\n   This load balancer must exists in the same resource group as the NIC."))).option("-r, --lb-inbound-nat-rule-name [lb-inbound-nat-rule-name]", $(("the name of the inbound NAT rule that exists in the load balancer." + "\n   Please use --inbound-nat-rule-id if that is not the case."))).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __7(resourceGroup, nicName, ipConfigName, options, _) { var networkManagementClient, nic; var __frame = { name: "__7", line: 174 }; return __func(_, this, arguments, __7, 4, __frame, function __$__7() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Network interface name: "), nicName, __cb(_, __frame, 2, 32, function ___(__0, __2) { nicName = __2;
          ...
          networkManagementClient = getNetworkManagementClient(options);
          nic = new Nic(cli, networkManagementClient);
          return nic.deleteInboundNatRule(resourceGroup, nicName, ipConfigName, options, __cb(_, __frame, 7, 10, function __$__7() { _(); }, true)); }, true)); }, true)); }); });
  ...
  dnsZone.command("create [resource-group] [name]").description($("Create a DNS zone")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the DNS zone")).option("-t, --tags [tags]", $(constants.help.tags.create)).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __8(resourceGroup, name, options, _) { var dnsManagementClient, dnsZone; var __frame = { name: "__8", line: 197 }; return __func(_, this, arguments, __8, 3, __frame, function __$__8() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("DNS zone name: "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          ...
          return dnsZone.create(resourceGroup, name, options, __cb(_, __frame, 6, 14, function __$__8() { _(); }, true)); }, true)); }, true)); }); });


  dnsZone.command("set [resource-group] [name]").description($("Set a DNS zone")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the DNS zone")).option("-t, --tags [tags]", $(constants.help.tags.set)).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __9(resourceGroup, name, options, _) { var dnsManagementClient, dnsZone; var __frame = { name: "__9", line: 213 }; return __func(_, this, arguments, __9, 3, __frame, function __$__9() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("DNS zone name: "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          ...
          dnsManagementClient = getDnsManagementClient(options);
          dnsZone = new DnsZone(cli, dnsManagementClient);
          return dnsZone.set(resourceGroup, name, options, __cb(_, __frame, 6, 14, function __$__9() { _(); }, true)); }, true)); }, true)); }); });


  dnsZone.command("list [resource-group]").description($("Get all DNS zones")).usage("[options] [resource-group]").option("-g, --resource-group [resource-group]", $("the name of the resource group")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __10(resourceGroup, options, _) { var dnsManagementClient, dnsZone; var __frame = { name: "__10", line: 227 }; return __func(_, this, arguments, __10, 2, __frame, function __$__10() {
      ...
      dnsManagementClient = getDnsManagementClient(options);
      dnsZone = new DnsZone(cli, dnsManagementClient);
      return dnsZone.list(options, __cb(_, __frame, 4, 14, function __$__10() { _(); }, true)); }); });


  dnsZone.command("show [resource-group] [name]").description($("Get a DNS zone")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $(("the name of the DNS zone" + "\n     You can specify \"*\" (in quotes) for this parameter"))).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __11(resourceGroup, name, options, _) { var dnsManagementClient, dnsZone; var __frame = { name: "__11", line: 241 }; return __func(_, this, arguments, __11, 3, __frame, function __$__11() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("DNS zone name: "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          ...
          dnsManagementClient = getDnsManagementClient(options);
          dnsZone = new DnsZone(cli, dnsManagementClient);
          return dnsZone.show(resourceGroup, name, options, __cb(_, __frame, 6, 14, function __$__11() { _(); }, true)); }, true)); }, true)); }); });


  dnsZone.command("clear [resource-group] [name]").description($("Delete all record sets in a DNS zone")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the DNS zone")).option("-q, --quiet", $("quiet mode, do not ask for clear confirmation")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __12(resourceGroup, name, options, _) { var dnsManagementClient, dnsZone; var __frame = { name: "__12", line: 257 }; return __func(_, this, arguments, __12, 3, __frame, function __$__12() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("DNS zone name: "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          return cli.interaction.promptIfNotGiven($("Zone file name: "), fileName, __cb(_, __frame, 3, 41, function ___(__0, __3) { options.fileName = __3;
            ...
            dnsManagementClient = getDnsManagementClient(options);
            dnsZone = new DnsZone(cli, dnsManagementClient);
            return dnsZone.import(resourceGroup, name, options, __cb(_, __frame, 7, 14, function __$__14() { _(); }, true)); }, true)); }, true)); }, true)); }); });


  dnsZone.command("export [resource-group] [name] [file-name]").description($("Export a DNS zone as a zone file")).usage("[options] <resource-group> <name> <file-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the DNS zone")).option("-f, --file-name <file-name>", $("the name of the zone file")).option("-q, --quiet", $("quiet mode, do not ask for overwrite confirmation")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __15(resourceGroup, name, fileName, options, _) { var dnsManagementClient, dnsZone; var __frame = { name: "__15", line: 311 }; return __func(_, this, arguments, __15, 4, __frame, function __$__15() {
        ...
        return cli.interaction.promptIfNotGiven($("DNS zone name: "), dnsZoneName, __cb(_, __frame, 2, 36, function ___(__0, __2) { dnsZoneName = __2;
          return cli.interaction.promptIfNotGiven($("Record set name: "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            return cli.interaction.promptIfNotGiven($("Type: "), type, __cb(_, __frame, 4, 37, function ___(__0, __4) { options.type = __4;
              ...
              dnsManagementClient = getDnsManagementClient(options);
              dnsZone = new DnsZone(cli, dnsManagementClient);
              return dnsZone.createRecordSet(resourceGroup, dnsZoneName, name, options, __cb(_, __frame, 8, 14, function __$__16() { _(); }, true)); }, true)); }, true)); }, true)); }, true)); }); });


  dnsRecordSet.command("set [resource-group] [dns-zone-name] [name] [type]").description($("Set a DNS zone record set")).usage("[options] <resource-group> <dns-zone-name> <name> <type>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-z, --dns-zone-name <dns-zone-name>", $("the name of the DNS zone")).option("-n, --name <name>", $("the relative name of the record set within the DNS zone")).option("-y, --type <type>", util.format($(("the type of the record set, valid values are" + "\n     [%s]")), constants.dnsZone.recordTypes)).option("-l, --ttl [ttl]", $("time to live specified in seconds")).option("-m, --metadata [metadata]", $(constants.help.tags.create)).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __17(resourceGroup, dnsZoneName, name, type, options, _) { var dnsManagementClient, dnsZone; var __frame = { name: "__17", line: 357 }; return __func(_, this, arguments, __17, 5, __frame, function __$__17() {
        ...
        return cli.interaction.promptIfNotGiven($("DNS zone name: "), dnsZoneName, __cb(_, __frame, 2, 36, function ___(__0, __2) { dnsZoneName = __2;
          return cli.interaction.promptIfNotGiven($("Record set name: "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            return cli.interaction.promptIfNotGiven($("Type: "), type, __cb(_, __frame, 4, 37, function ___(__0, __4) { options.type = __4;
              ...
              dnsManagementClient = getDnsManagementClient(options);
              dnsZone = new DnsZone(cli, dnsManagementClient);
              return dnsZone.setRecordSet(resourceGroup, dnsZoneName, name, options, __cb(_, __frame, 8, 14, function __$__17() { _(); }, true)); }, true)); }, true)); }, true)); }, true)); }); });


  dnsRecordSet.command("set-soa-record [resource-group] [dns-zone-name] [record-set-name]").description($("Set a SOA record in a record set under a DNS zone")).usage("[options] <resource-group> <dns-zone-name> <record-set-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-z, --dns-zone-name <dns-zone-name>", $("the name of the DNS zone")).option("-e, --email [email]", $("the email attribute")).option("-i, --expire-time [expire-time]", $("the expire time specified in seconds")).option("-S, --serial-number [serial-number]", $("the serial number")).option("-n, --minimum-ttl [minimum-ttl]", $("the minimum time to live specified in seconds")).option("-r, --refresh-time [refresh-time]", $("the refresh time specified in seconds")).option("-j, --retry-time [retry-time]", $("the retry time specified in seconds")).option("-l, --ttl [ttl]", $("time to live specified in seconds")).option("-m, --metadata [metadata]", $(constants.help.tags.create)).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __18(resourceGroup, dnsZoneName, recordSetName, options, _) { var dnsManagementClient, dnsZone; var __frame = { name: "__18", line: 382 }; return __func(_, this, arguments, __18, 4, __frame, function __$__18() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("DNS zone name: "), dnsZoneName, __cb(_, __frame, 2, 36, function ___(__0, __2) { dnsZoneName = __2;
          ...
          dnsManagementClient = getDnsManagementClient(options);
          dnsZone = new DnsZone(cli, dnsManagementClient);
          return dnsZone.setSoaRecord(resourceGroup, dnsZoneName, options, __cb(_, __frame, 6, 14, function __$__18() { _(); }, true)); }, true)); }, true)); }); });


  dnsRecordSet.command("list [resource-group] [dns-zone-name] [type]").description($("Get all record sets in a DNS zone")).usage("[options] <resource-group> <dns-zone-name> [type]").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-z, --dns-zone-name <dns-zone-name>", $("the name of the DNS zone")).option("-y, --type [type]", util.format($((("the type of the record set, " + "\n     If specified only record sets of this type will be listed.") + "\n     valid values are [%s]")), constants.dnsZone.recordTypes)).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __19(resourceGroup, dnsZoneName, type, options, _) { var dnsManagementClient, dnsZone; var __frame = { name: "__19", line: 400 }; return __func(_, this, arguments, __19, 4, __frame, function __$__19() {
        ...
        return cli.interaction.promptIfNotGiven($("DNS zone name: "), dnsZoneName, __cb(_, __frame, 2, 36, function ___(__0, __2) { dnsZoneName = __2;
          return cli.interaction.promptIfNotGiven($("Record set name: "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            return cli.interaction.promptIfNotGiven($("Type: "), type, __cb(_, __frame, 4, 37, function ___(__0, __4) { options.type = __4;
              ...
              dnsManagementClient = getDnsManagementClient(options);
              dnsZone = new DnsZone(cli, dnsManagementClient);
              return dnsZone.showRecordSet(resourceGroup, dnsZoneName, name, options, __cb(_, __frame, 8, 14, function __$__20() { _(); }, true)); }, true)); }, true)); }, true)); }, true)); }); });


  dnsRecordSet.command("delete [resource-group] [dns-zone-name] [name] [type]").description($("Delete a record set from a DNS zone")).usage("[options] <resource-group> <dns-zone-name> <name> <type>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-z, --dns-zone-name <dns-zone-name>", $("the name of the DNS zone")).option("-n, --name <name>", $("the relative name of the record set within the DNS zone")).option("-y, --type <type>", util.format($(("the type of the record set, " + "\n     valid values are [%s]")), constants.dnsZone.restrictedRecordTypes)).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __21(resourceGroup, dnsZoneName, name, type, options, _) { var dnsManagementClient, dnsZone; var __frame = { name: "__21", line: 440 }; return __func(_, this, arguments, __21, 5, __frame, function __$__21() {
          ...
          return cli.interaction.promptIfNotGiven($("Record set name: "), recordSetName, __cb(_, __frame, 3, 38, function ___(__0, __3) { recordSetName = __3;
            return cli.interaction.promptIfNotGiven($("Type: "), type, __cb(_, __frame, 4, 37, function ___(__0, __4) { options.type = __4;
              ...
              return dnsZone.promptRecordParamsIfNotGiven(options, __cb(_, __frame, 8, 14, function __$__22() {
                return dnsZone.addRecord(resourceGroup, dnsZoneName, recordSetName, options, __cb(_, __frame, 9, 14, function __$__22() { _(); }, true)); }, true)); }, true)); }, true)); }, true)); }, true)); }); });


  dnsRecordSet.command("delete-record [resource-group] [dns-zone-name] [record-set-name] [type]").description($("Delete a record from a record set under a DNS zone")).usage("[options] <resource-group> <dns-zone> <record-set-name> <type>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-z, --dns-zone-name <dns-zone-name>", $("the name of the DNS zone")).option("-n, --record-set-name <record-set-name>", $("the name of the record set")).option("-y, --type <type>", util.format($((("the type of the record set." + "\n     Valid values are [%s]") + "\nThe record type A \n")), constants.dnsZone.setTypes)).option("-a  --ipv4-address [ipv4-address]", $(("the IPv4 address attribute\n" + "\nRecord type AAAA"))).option("-b  --ipv6-address [ipv6-address]", $(("the IPv6 address attribute\n" + "\nRecord type CNAME"))).option("-c  --cname [cname]", $(("the canonical name (target)\n" + "\nRecord type MX"))).option("-f, --preference [preference]", $("preference attribute")).option("-e, --exchange [exchange]", $(("exchange attribute\n" + "\nRecord type PTR"))).option("-P, --ptrdname [ptrdname]", $(("ptr domain name\n" + "\nRecord type NS"))).option("-d  --nsdname [nsdname]", $(("the domain name attribute\n" + "\nRecord type SRV"))).option("-p, --priority [priority]", $("the priority attribute")).option("-w, --weight [weight]", $("the weight attribute")).option("-o, --port [port]", $("the port")).option("-u, --target [target]", $(("the target attribute\n" + "\nRecord type TXT"))).option("-x, --text [text]", $("the text attribute\n")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("--keep-empty-record-set", $("keep the empty record set when deleting the last record in the record set")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __23(resourceGroup, dnsZoneName, recordSetName, type, options, _) { var dnsManagementClient, dnsZone; var __frame = { name: "__23", line: 525 }; return __func(_, this, arguments, __23, 5, __frame, function __$__23() {
        ...
        return cli.interaction.promptIfNotGiven($("DNS zone name: "), dnsZoneName, __cb(_, __frame, 2, 36, function ___(__0, __2) { dnsZoneName = __2;
          return cli.interaction.promptIfNotGiven($("Record set name: "), recordSetName, __cb(_, __frame, 3, 38, function ___(__0, __3) { recordSetName = __3;
            return cli.interaction.promptIfNotGiven($("Type: "), type, __cb(_, __frame, 4, 37, function ___(__0, __4) { options.type = __4;
              ...
              dnsManagementClient = getDnsManagementClient(options);
              dnsZone = new DnsZone(cli, dnsManagementClient);
              return dnsZone.promptRecordParamsIfNotGiven(options, __cb(_, __frame, 8, 14, function __$__23() {
                return dnsZone.deleteRecord(resourceGroup, dnsZoneName, recordSetName, options, __cb(_, __frame, 9, 14, function __$__23() { _(); }, true)); }, true)); }, true)); }, true)); }, true)); }, true)); }); });
  ...
  vpnGatewayRootCert.command("create [resource-group] [name] [cert-name] [cert-file]").description($("Add a root certificate to a virtual network gateway")).usage("[options] <resource-group> <name> <cert-name> <cert-file>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the virtual network gateway")).option("-c, --cert-name <cert-name>", $("the name of the root certificate")).option("-f, --cert-file <cert-file>", $("the path to the root certificate")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __24(resourceGroup, name, certName, certFile, options, _) { var networkManagementClient, vnetGateway; var __frame = { name: "__24", line: 551 }; return __func(_, this, arguments, __24, 5, __frame, function __$__24() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Virtual network gateway name: "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          return cli.interaction.promptIfNotGiven($("Root certificate name: "), certName, __cb(_, __frame, 3, 33, function ___(__0, __3) { certName = __3;
            ...
            networkManagementClient = getNetworkManagementClient(options);
            vnetGateway = new VirtualNetworkGateway(cli, networkManagementClient);
            return vnetGateway.deleteRootCert(resourceGroup, name, certName, options, __cb(_, __frame, 7, 18, function __$__25() { _(); }, true)); }, true)); }, true)); }, true)); }); });
  ...
  vpnGatewayRevokedCert.command("create [resource-group] [name] [cert-name] [thumbprint]").description($("Add a revoked certificate to a virtual network gateway")).usage("[options] <resource-group> <name> <cert-name> <thumbprint>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the virtual network gateway")).option("-c, --cert-name <cert-name>", $("the name of the revoked certificate")).option("-f, --thumbprint <thumbprint>", $("the certificate thumbprint")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __26(resourceGroup, name, certName, thumbprint, options, _) { var networkManagementClient, vnetGateway; var __frame = { name: "__26", line: 591 }; return __func(_, this, arguments, __26, 5, __frame, function __$__26() {
        ...
        return cli.interaction.promptIfNotGiven($("Connection name: "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          return cli.interaction.promptIfNotGiven($("Location: "), location, __cb(_, __frame, 3, 41, function ___(__0, __3) { options.location = __3;
            return cli.interaction.promptIfNotGiven($("Virtual network gateway: "), (vnetGateway1 || options.vnetGateway1), __cb(_, __frame, 4, 45, function ___(__0, __4) { options.vnetGateway1 = __4;
              ...
              return vpnGateway.createConnection(resourceGroup, name, options, __cb(_, __frame, 8, 17, function __$__28() { _(); }, true)); }, true)); }, true)); }, true)); }, true)); }); });


  gatewayConnection.command("set [resource-group] [name]").description($("Set a gateway connection")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the gateway connection")).option("-w, --routing-weight [routing-weight]", $("the routing weight")).option("-b, --enable-bgp [enable-bgp]", $("whether BGP is enabled for this virtual network gateway or not")).option("-s, --subscription <subscription>", $("the subscription identifier")).option("-t, --tags [tags]", $(constants.help.tags.set)).execute(function __29(resourceGroup, name, options, _) { var networkManagementClient, vpnGateway; var __frame = { name: "__29", line: 664 }; return __func(_, this, arguments, __29, 3, __frame, function __$__29() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Connection name: "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          ...
          networkManagementClient = getNetworkManagementClient(options);
          vpnGateway = new VirtualNetworkGateway(cli, networkManagementClient);
          return vpnGateway.setConnection(resourceGroup, name, options, __cb(_, __frame, 6, 17, function __$__29() { _(); }, true)); }, true)); }, true)); }); });


  gatewayConnection.command("list [resource-group]").description($("Get all gateway connections")).usage("[options] <resource-group>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __30(resourceGroup, options, _) { var networkManagementClient, vpnGateway; var __frame = { name: "__30", line: 678 }; return __func(_, this, arguments, __30, 2, __frame, function __$__30() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        ...
        networkManagementClient = getNetworkManagementClient(options);
        vpnGateway = new VirtualNetworkGateway(cli, networkManagementClient);
        return vpnGateway.listConnections(resourceGroup, options, __cb(_, __frame, 5, 17, function __$__30() { _(); }, true)); }, true)); }); });


  gatewayConnection.command("show [resource-group] [name]").description($("Get details about gateway connection")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the gateway connection")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __31(resourceGroup, name, options, _) { var networkManagementClient, vpnGateway; var __frame = { name: "__31", line: 692 }; return __func(_, this, arguments, __31, 3, __frame, function __$__31() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Connection name: "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          ...
          networkManagementClient = getNetworkManagementClient(options);
          vpnGateway = new VirtualNetworkGateway(cli, networkManagementClient);
          return vpnGateway.showConnection(resourceGroup, name, options, __cb(_, __frame, 6, 17, function __$__31() { _(); }, true)); }, true)); }, true)); }); });


  gatewayConnection.command("delete [resource-group] [name]").usage("[options] <resource-group> <name>").description($("Delete a gateway connection")).option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the gateway connection")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __32(resourceGroup, name, options, _) { var networkManagementClient, vpnGateway; var __frame = { name: "__32", line: 708 }; return __func(_, this, arguments, __32, 3, __frame, function __$__32() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Connection name: "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          ...
          networkManagementClient = getNetworkManagementClient(options);
          vpnGateway = new VirtualNetworkGateway(cli, networkManagementClient);
          return vpnGateway.deleteConnection(resourceGroup, name, options, __cb(_, __frame, 6, 17, function __$__32() { _(); }, true)); }, true)); }, true)); }); });
  ...
  connectionSharedKey.command("set [resource-group] [name] [value]").description($("Set gateway connection shared key")).usage("[options] <resource-group> <name> <value>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the gateway connection")).option("-k, --value <value>", $("the shared key value")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __33(resourceGroup, name, value, options, _) { var networkManagementClient, vpnGateway; var __frame = { name: "__33", line: 727 }; return __func(_, this, arguments, __33, 4, __frame, function __$__33() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Connection name: "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          return cli.interaction.promptIfNotGiven($("Shared key value: "), value, __cb(_, __frame, 3, 38, function ___(__0, __3) { options.value = __3;
            ...
            networkManagementClient = getNetworkManagementClient(options);
            vpnGateway = new VirtualNetworkGateway(cli, networkManagementClient);
            return vpnGateway.setConnectionSharedKey(resourceGroup, name, options, __cb(_, __frame, 7, 17, function __$__33() { _(); }, true)); }, true)); }, true)); }, true)); }); });


  connectionSharedKey.command("reset [resource-group] [name] [key-length]").description($("Reset gateway connection shared key")).usage("[options] <resource-group> <name> <key-length>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the gateway connection")).option("-l, --key-length <key-length>", $("the shared key length")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __34(resourceGroup, name, keyLength, options, _) { var networkManagementClient, vpnGateway; var __frame = { name: "__34", line: 744 }; return __func(_, this, arguments, __34, 4, __frame, function __$__34() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Connection name: "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          return cli.interaction.promptIfNotGiven($("Shared key length: "), keyLength, __cb(_, __frame, 3, 42, function ___(__0, __3) { options.keyLength = __3;
            ...
            networkManagementClient = getNetworkManagementClient(options);
            vpnGateway = new VirtualNetworkGateway(cli, networkManagementClient);
            return vpnGateway.resetConnectionSharedKey(resourceGroup, name, options, __cb(_, __frame, 7, 17, function __$__34() { _(); }, true)); }, true)); }, true)); }, true)); }); });


  connectionSharedKey.command("show [resource-group] [name]").description($("Get details about gateway connection shared key")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the gateway connection")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __35(resourceGroup, name, options, _) { var networkManagementClient, vpnGateway; var __frame = { name: "__35", line: 760 }; return __func(_, this, arguments, __35, 3, __frame, function __$__35() {
  ...
  appGateway.command("create [resource-group] [name] [location] [servers]").description($("Create an application gateway")).usage("[options] <resource-group> <name> <location> <servers>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the application gateway")).option("-l, --location <location>", $("the location")).option("-e, --vnet-name [vnet-name]", $("the name of the virtual network application gateway should be deployed in")).option("-m, --subnet-name [subnet-name]", $("the name of subnet in the virtual network identified by --vnet-name")).option("-d, --subnet-id [subnet-id]", util.format($(("the subnet identifier." + "\n     e.g. %s")), constants.help.id.subnet)).option("-y, --cert-file [cert-file]", $("the path to the certificate")).option("-x, --cert-password [cert-password]", $("the certificate password")).option("-A, --address-pool-name [address-pool-name]", util.format($(("the address pool name. " + "\n     Default value is \"%s\"")), constants.appGateway.pool.name)).option("-r, --servers <servers>", $("comma separated list of IP addresses or DNS names corresponding to backend servers")).option("-O, --http-settings-name [http-settings-name]", util.format($(("the HTTP settings name. " + "\n     Default value is \"%s\"")), constants.appGateway.settings.name)).option("-i, --http-settings-protocol [http-settings-protocol]", util.format($("the HTTP settings protocol, valid values are [%s]"), constants.appGateway.settings.protocol)).option("-o, --http-settings-port [http-settings-port]", util.format($("the HTTP settings port, valid range is"), utils.toRange(constants.appGateway.settings.port))).option("-f, --http-settings-cookie-based-affinity [http-settings-cookie-based-affinity]", util.format($((("Enable or disable HTTP settings cookie based affinity, valid values are" + "\n     [%s],") + "\n     default value is \"%s\"")), constants.appGateway.settings.affinity, constants.appGateway.settings.affinity[0])).option("-J, --frontend-port-name [frontend-port-name]", util.format($(("the frontend port name." + "\n     Default value is \"%s\"")), constants.appGateway.frontendPort.name)).option("-j, --frontend-port [frontend-port]", util.format($("the frontend port value, valid range is"), utils.toRange(constants.appGateway.settings.port))).option("-F, --frontend-ip-name [frontend-ip-name]", util.format($(("the frontend ip name. " + "\n     Default value is \"%s\"")), constants.appGateway.frontendIp.name)).option("-k, --public-ip-name [public-ip-name]", $("the name of the public ip")).option("-p, --public-ip-id [public-ip-id]", util.format($(("the public ip identifier." + "\n     e.g. %s")), constants.help.id.publicIp)).option("-G, --gateway-ip-name [gateway-ip-name]", util.format($(("the gateway ip name." + "\n     Default value is \"%s\"")), constants.appGateway.gatewayIp.name)).option("-L, --http-listener-name [http-listener-name]", util.format($(("the HTTP listener name." + "\n     Default value is \"%s\"")), constants.appGateway.httpListener.name)).option("-b, --http-listener-protocol [http-listener-protocol]", util.format($("the HTTP listener protocol, valid values are [%s]"), constants.appGateway.httpListener.protocol)).option("-R, --routing-rule-name [routing-rule-name]", util.format($(("the routing rule name." + "\n     Default name is \"%s\"")), constants.appGateway.routingRule.name)).option("-w, --routing-rule-type [routing-rule-type]", util.format($("the request routing rule type, default is \"%s\""), constants.appGateway.routingRule.type[0])).option("-a, --sku-name [sku-name]", util.format($("the name of the sku, valid values are [%s]. Default values is \"%s\""), constants.appGateway.sku.name, constants.appGateway.sku.name[0])).option("-u, --sku-tier [sku-tier]", util.format($("the sku tier, valid values are [%s]. Default values is \"%s\""), constants.appGateway.sku.name.tier, constants.appGateway.sku.tier[0])).option("-z, --capacity [capacity]", util.format($("application gateway instance count in range [%s]. Default value is %s."), constants.appGateway.sku.capacity, constants.appGateway.sku.capacity[0])).option("-t, --tags [tags]", $(constants.help.tags.create)).option("--nowait", $("does not wait for the operation to complete. Returns as soon as the intial request is received by the server.")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __36(resourceGroup, name, location, servers, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__36", line: 828 }; return __func(_, this, arguments, __36, 5, __frame, function __$__36() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Application gateway name: "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          return cli.interaction.promptIfNotGiven($("Location: "), location, __cb(_, __frame, 3, 33, function ___(__0, __3) { location = __3; return (function __$__36(__then) {
              ...
              if ((((options.httpListenerProtocol && (options.httpListenerProtocol.toLowerCase() === constants.appGateway.httpListener.protocol[1].toLowerCase()))) || options.certFile)) {
                return cli.interaction.promptIfNotGiven($("SSL certificate full path: "), options.certFile, __cb(_, __frame, 6, 43, function ___(__0, __4) { options.certFile = __4;
                  return cli.interaction.promptIfNotGiven($("SSL certificate password: "), options.certPassword, __cb(_, __frame, 7, 47, function ___(__0, __5) { options.certPassword = __5; __then(); }, true)); }, true)); } else { __then(); } ; })(function __$__36() { return (function __$__36(__then) {
                ...
                if (!options.subnetId) {
                  return cli.interaction.promptIfNotGiven($("Virtual network name: "), options.vnetName, __cb(_, __frame, 10, 43, function ___(__0, __6) { options.vnetName = __6;
                    return cli.interaction.promptIfNotGiven($("Subnet name: "), options.subnetName, __cb(_, __frame, 11, 45, function ___(__0, __7) { options.subnetName = __7; __then(); }, true)); }, true)); } else { __then(); } ; })(function __$__36() {
                ...
                return cli.interaction.promptIfNotGiven($("Comma separated backend server IPs: "), (servers || options.servers), __cb(_, __frame, 13, 40, function ___(__0, __8) { options.servers = __8;
                  ...
                  return appGateway.createAppGateway(resourceGroup, name, location, options, __cb(_, __frame, 17, 17, function __$__36() { _(); }, true)); }, true)); }); }); }, true)); }, true)); }, true)); }); });


  appGateway.command("set [resource-group] [name]").description($("Set an application gateway")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the application gateway")).option("-a, --sku-name [sku-name]", util.format($("the name of the sku, valid values are [%s]"), constants.appGateway.sku.name)).option("-u, --sku-tier [sku-tier]", util.format($("the sku tier, valid values are [%s]"), constants.appGateway.sku.tier)).option("-z, --capacity [capacity]", util.format($("application gateway instance count in range [%s]"), constants.appGateway.sku.capacity)).option("-t, --tags [tags]", $(constants.help.tags.set)).option("--nowait", $("does not wait for the operation to complete. Returns as soon as the intial request is received by the server.")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __37(resourceGroup, name, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__37", line: 862 }; return __func(_, this, arguments, __37, 3, __frame, function __$__37() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Application gateway name: "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          ...
          networkManagementClient = getNetworkManagementClient(options);
          appGateway = new AppGateway(cli, networkManagementClient);
          return appGateway.setAppGateway(resourceGroup, name, options, __cb(_, __frame, 6, 17, function __$__37() { _(); }, true)); }, true)); }, true)); }); });
  ...
  appGatewayUrlPathMap.command("set [resource-group] [gateway-name] [name]").description($("Set url path map in application gateway")).usage("[options] <resource-group> <gateway-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --gateway-name <gateway-name>", $("the name of the application gateway")).option("-n, --name <name>", $("the name of the url path map")).option("-i, --http-settings-name [http-settings-name]", $("the name of an existing backend HTTP settings")).option("-a, --address-pool-name [address-pool-name]", $("the name of an existing backend address pool")).option("--nowait", $("does not wait for the operation to complete. Returns as soon as the intial request is received by the server.")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __38(resourceGroup, gatewayName, name, ruleName, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__38", line: 884 }; return __func(_, this, arguments, __38, 5, __frame, function __$__38() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Application gateway name: "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __2) { gatewayName = __2;
          return cli.interaction.promptIfNotGiven($("Url path map name: "), name, __cb(_, __frame, 3, 29, function ___(__0, __3) { name = __3;
            ...
            networkManagementClient = getNetworkManagementClient(options);
            appGateway = new AppGateway(cli, networkManagementClient);
            return appGateway.setUrlPathMap(resourceGroup, gatewayName, name, options, __cb(_, __frame, 7, 17, function __$__38() { _(); }, true)); }, true)); }, true)); }, true)); }); });
              ...
              return cli.interaction.promptIfNotGiven($("Path: "), options.path, __cb(_, __frame, 5, 37, function ___(__0, __5) { options.path = __5;
                return cli.interaction.promptIfNotGiven($("HTTP settings name: "), options.httpSettingsName, __cb(_, __frame, 6, 49, function ___(__0, __6) { options.httpSettingsName = __6;
                  return cli.interaction.promptIfNotGiven($("The address pool name: "), options.addressPoolName, __cb(_, __frame, 7, 48, function ___(__0, __7) { options.addressPoolName = __7;
                    ...
                    networkManagementClient = getNetworkManagementClient(options);
                    appGateway = new AppGateway(cli, networkManagementClient);
                    return appGateway.addMapRule(resourceGroup, gatewayName, name, options, __cb(_, __frame, 11, 17, function __$__39() { _(); }, true)); }, true)); }, true)); }, true)); }, true)); }, true)); }, true)); }, true)); }); });


  appGatewayUrlPathMapRule.command("set [resource-group] [gateway-name] [url-path-map-name] [name]").description($("Set url path map rule in application gateway")).usage("[options] <resource-group> <gateway-name> <url-path-map-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --gateway-name <gateway-name>", $("the name of the application gateway")).option("-u, --url-path-map-name <url-path-map-name>", $("the name of the url path map")).option("-n, --name <name>", $("the name of the url path map rule")).option("-p, --path [path]", $("path, which specifies application gateway path rule")).option("-i, --http-settings-name [http-settings-name]", $("the name of an existing backend HTTP settings")).option("-a, --address-pool-name [address-pool-name]", $("the name of an existing backend address pool")).option("--nowait", $("does not wait for the operation to complete. Returns as soon as the intial request is received by the server.")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __40(resourceGroup, gatewayName, urlPathMapName, name, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__40", line: 935 }; return __func(_, this, arguments, __40, 5, __frame, function __$__40() {
        ...
        return cli.interaction.promptIfNotGiven($("Application gateway name: "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __2) { gatewayName = __2;
          return cli.interaction.promptIfNotGiven($("Url path map name: "), (urlPathMapName || options.urlPathMapName), __cb(_, __frame, 3, 47, function ___(__0, __3) { options.urlPathMapName = __3;
            return cli.interaction.promptIfNotGiven($("Rule name: "), name, __cb(_, __frame, 4, 29, function ___(__0, __4) { name = __4;
              ...
              networkManagementClient = getNetworkManagementClient(options);
              appGateway = new AppGateway(cli, networkManagementClient);
              return appGateway.setMapRule(resourceGroup, gatewayName, name, options, __cb(_, __frame, 8, 17, function __$__40() { _(); }, true)); }, true)); }, true)); }, true)); }, true)); }); });


  appGatewayUrlPathMapRule.command("show [resource-group] [gateway-name] [url-path-map-name] [name]").description($("Show url path map rule from application gateway")).usage("[options] <resource-group> <gateway-name> <url-path-map-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --gateway-name <gateway-name>", $("the name of the application gateway")).option("-u, --url-path-map-name <url-path-map-name>", $("the name of the url path map")).option("-n, --name <name>", $("the name of the url path map rule")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __41(resourceGroup, gatewayName, urlPathMapName, name, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__41", line: 954 }; return __func(_, this, arguments, __41, 5, __frame, function __$__41() {
        ...
        return cli.interaction.promptIfNotGiven($("Application gateway name: "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __2) { gatewayName = __2;
          return cli.interaction.promptIfNotGiven($("URL path map name: "), urlPathMapName, __cb(_, __frame, 3, 39, function ___(__0, __3) { urlPathMapName = __3;
            return cli.interaction.promptIfNotGiven($("Url path map name: "), name, __cb(_, __frame, 4, 29, function ___(__0, __4) { name = __4;
              ...
              networkManagementClient = getNetworkManagementClient(options);
              appGateway = new AppGateway(cli, networkManagementClient);
              return appGateway.showUrlPathMapRule(resourceGroup, gatewayName, urlPathMapName, name, options, __cb(_, __frame, 8, 17, function __$__41() { _(); }, true)); }, true)); }, true)); }, true)); }, true)); }); });


  appGatewayUrlPathMapRule.command("list [resource-group] [gateway-name] [url-path-map-name]").description($("List url path map rule from application gateway")).usage("[options] <resource-group> <gateway-name> <url-path-map-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --gateway-name <gateway-name>", $("the name of the application gateway")).option("-u, --url-path-map-name <url-path-map-name>", $("the name of the url path map")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __42(resourceGroup, gatewayName, urlPathMapName, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__42", line: 972 }; return __func(_, this, arguments, __42, 4, __frame, function __$__42() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group name: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Application gateway name: "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __2) { gatewayName = __2;
          return cli.interaction.promptIfNotGiven($("URL path map name: "), urlPathMapName, __cb(_, __frame, 3, 39, function ___(__0, __3) { urlPathMapName = __3;
            ...
            networkManagementClient = getNetworkManagementClient(options);
            appGateway = new AppGateway(cli, networkManagementClient);
            return appGateway.listUrlPathMapRules(resourceGroup, gatewayName, urlPathMapName, options, __cb(_, __frame, 7, 17, function __$__42() { _(); }, true)); }, true)); }, true)); }, true)); }); });


  appGatewayUrlPathMapRule.command("delete [resource-group] [gateway-name] [url-path-map-name] [name]").description($("Delete an url path map rule from an application gateway")).usage("[options] <resource-group> <gateway-name> <url-path-map-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --gateway-name <gateway-name>", $("the name of the application gateway")).option("-u, --url-path-map-name <url-path-map-name>", $("the name of the url path map")).option("-n, --name <name>", $("the name of the map rule")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("--nowait", $("does not wait for the operation to complete. Returns as soon as the intial request is received by the server.")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __43(resourceGroup, gatewayName, urlPathMapName, name, options, _) { var networkManagementClient, appGateway; var __frame = { name: "__43", line: 992 }; return __func(_, this, arguments, __43, 5, __frame, function __$__43() {
        ...
        return cli.interaction.promptIfNotGiven($("Application gateway name: "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __2) { gatewayName = __2;
          return cli.interaction.promptIfNotGiven($("Url path map rule name: "), (urlPathMapName || options.urlPathMapName), __cb(_, __frame, 3, 47, function ___(__0, __3) { options.urlPathMapName = __3;
            return cli.interaction.promptIfNotGiven($("Url path map rule name: "), name, __cb(_, __frame, 4, 29, function ___(__0, __4) { name = __4;
              ...
              networkManagementClient = getNetworkManagementClient(options);
              appGateway = new AppGateway(cli, networkManagementClient);
              return appGateway.removeMapRule(resourceGroup, gatewayName, name, options, __cb(_, __frame, 8, 17, function __$__43() { _(); }, true)); }, true)); }, true)); }, true)); }, true)); }); });
  ...
  disabledRuleGroups.command("create [resource-group] [gateway-name] [rule-group-name]").description($("Create a group of disabled rules")).usage("[options] <resource-group> <gateway-name> <rule-group-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --gateway-name <gateway-name>", $("the gateway name")).option("-n, --rule-group-name <rule-group-name>", $("the name of the rule group that will be disabled")).option("-r, --rules [rules]", $("The list of rules that will be disabled. If null, all rules of the rule group will be disabled")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __44(resourceGroup, gatewayName, ruleGroupName, options, _) { var subscription, networkManagementClient, appGateway; var __frame = { name: "__44", line: 1017 }; return __func(_, this, arguments, __44, 4, __frame, function __$__44() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Application gateway name: "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __2) { gatewayName = __2;
          return cli.interaction.promptIfNotGiven($("rule group name: "), ruleGroupName, __cb(_, __frame, 3, 46, function ___(__0, __3) { options.ruleGroupName = __3;
            ...
            appGateway = new AppGateway(cli, networkManagementClient);
            return appGateway.createDisabledRuleGroup(resourceGroup, gatewayName, options, __cb(_, __frame, 8, 17, function __$__44() { _(); }, true)); }, true)); }, true)); }, true)); }); });


  disabledRuleGroups.command("set [resource-group] [gateway-name] [rule-group-name]").description($("Update a group of disabled rules")).usage("[options] <resource-group> <gateway-name> <rule-group-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --gateway-name <gateway-name>", $("the gateway name")).option("-n, --rule-group-name <rule-group-name>", $("the name of the rule group that will be disabled")).option("-r, --rules [rules]", $("The list of rules that will be disabled. If null, all rules of the rule group will be disabled")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __45(resourceGroup, gatewayName, ruleGroupName, options, _) { var subscription, networkManagementClient, appGateway; var __frame = { name: "__45", line: 1036 }; return __func(_, this, arguments, __45, 4, __frame, function __$__45() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Application gateway name: "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __2) { gatewayName = __2;
          return cli.interaction.promptIfNotGiven($("rule group name: "), ruleGroupName, __cb(_, __frame, 3, 46, function ___(__0, __3) { options.ruleGroupName = __3;
            ...
            networkManagementClient = utils.createNetworkManagementClient(subscription);
            appGateway = new AppGateway(cli, networkManagementClient);
            return appGateway.setDisabledRuleGroup(resourceGroup, gatewayName, options, __cb(_, __frame, 8, 17, function __$__45() { _(); }, true)); }, true)); }, true)); }, true)); }); });


  disabledRuleGroups.command("show [resource-group] [gateway-name] [rule-group-name]").description($("Get a group of disabled rules")).usage("[options] <resource-group> <gateway-name> <rule-group-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --gateway-name <gateway-name>", $("the gateway name")).option("-n, --rule-group-name <rule-group-name>", $("the name of the rule group that will be disabled")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __46(resourceGroup, gatewayName, ruleGroupName, options, _) { var subscription, networkManagementClient, appGateway; var __frame = { name: "__46", line: 1054 }; return __func(_, this, arguments, __46, 4, __frame, function __$__46() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Application gateway name: "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __2) { gatewayName = __2;
          return cli.interaction.promptIfNotGiven($("rule group name: "), ruleGroupName, __cb(_, __frame, 3, 46, function ___(__0, __3) { options.ruleGroupName = __3;
            ...
            networkManagementClient = utils.createNetworkManagementClient(subscription);
            appGateway = new AppGateway(cli, networkManagementClient);
            return appGateway.showDisabledRuleGroup(resourceGroup, gatewayName, options, __cb(_, __frame, 8, 17, function __$__46() { _(); }, true)); }, true)); }, true)); }, true)); }); });


  disabledRuleGroups.command("list [resource-group] [gateway-name]").description($("List all disabled rule groups for a gateway")).usage("[options] <resource-group> <gateway-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --gateway-name <gateway-name>", $("the gateway name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __47(resourceGroup, gatewayName, options, _) { var subscription, networkManagementClient, appGateway; var __frame = { name: "__47", line: 1071 }; return __func(_, this, arguments, __47, 3, __frame, function __$__47() {
      ...
      return cli.interaction.promptIfNotGiven($("Resource group: "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("Application gateway name: "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __2) { gatewayName = __2;
          return cli.interaction.promptIfNotGiven($("rule group name: "), ruleGroupName, __cb(_, __frame, 3, 46, function ___(__0, __3) { options.ruleGroupName = __3;
            ...
            networkManagementClient = utils.createNetworkManagementClient(subscription);
            appGateway = new AppGateway(cli, networkManagementClient);
            return appGateway.deleteDisabledRuleGroup(resourceGroup, gatewayName, options, __cb(_, __frame, 8, 17, function __$__48() { _(); }, true)); }, true)); }, true)); }, true)); }); });
