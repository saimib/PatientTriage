...
exports.init = function(cli) {
              ...
              return cli.interaction.promptIfNotGiven($("rule set type : "), ruleSetType, __cb(_, __frame, 5, 44, function ___(__0, __5) { options.ruleSetType = __5;
                return cli.interaction.promptIfNotGiven($("rule set version : "), ruleSetVersion, __cb(_, __frame, 6, 47, function ___(__0, __6) { options.ruleSetVersion = __6;
                  ...
                  progress = cli.interaction.progress(util.format($("Looking up the application gateway \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                      ...
                      progress = cli.interaction.progress(util.format($("Creating web application firewall configuration in \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {

                            return networkManagementClient.applicationGateways.createOrUpdate(resourceGroup, gatewayName, applicationGateway, __cb(_, __frame, 54, 73, function ___(__0, __8) { applicationGateway = __8; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__1() {

                              progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$__1() {


                          cli.interaction.formatOutput(applicationGateway.webApplicationFirewallConfiguration, generatorUtils.traverse); _(); }); }); }); }); }, true)); }, true)); }, true)); }, true)); }, true)); }, true)); }); });


  webApplicationFirewallConfiguration.command("set [resource-group] [gateway-name]").description($("Update a web application firewall configuration")).usage("[options] <resource-group> <gateway-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --gateway-name <gateway-name>", $("the gateway name")).option("-e, --enable [enable]", $(("whether the web application firewall is" + "\n     enabled or not"))).option("-m, --waf-mode [waf-mode]", $("web application firewall mode")).option("-y, --rule-set-type [rule-set-type]", $(("the type of the web application" + "\n     firewall rule set. Possible values are: 'OWASP'"))).option("-r, --rule-set-version [rule-set-version]", $("the version of the rule set type")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, gatewayName, options, _) { var subscription, networkManagementClient, applicationGateway, progress, webApplicationFirewallConfiguration, parameters; var __frame = { name: "__2", line: 127 }; return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
      ...
      return cli.interaction.promptIfNotGiven($("resource group : "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __1) { resourceGroup = __1;
        return cli.interaction.promptIfNotGiven($("gateway name : "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __2) { gatewayName = __2;
          ...
          progress = cli.interaction.progress(util.format($("Looking up the application gateway \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
              ...
              webApplicationFirewallConfiguration = applicationGateway.webApplicationFirewallConfiguration;
              if (!webApplicationFirewallConfiguration) {
                return _(new Error(util.format($("web application firewall configuration not found in the \"%s\""), gatewayName))); } ;
              ...
              generatorUtils.removeEmptyObjects(parameters);
              progress = cli.interaction.progress(util.format($("Updating web application firewall configuration in \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {

                    return networkManagementClient.applicationGateways.createOrUpdate(resourceGroup, gatewayName, applicationGateway, __cb(_, __frame, 52, 73, function ___(__0, __4) { applicationGateway = __4; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__2() {

                      progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$__2() {

                  cli.interaction.formatOutput(applicationGateway.webApplicationFirewallConfiguration, generatorUtils.traverse); _(); }); }); }); }); }, true)); }, true)); }); });


  webApplicationFirewallConfiguration.command("delete [resource-group] [gateway-name]").description($("Delete a web application firewall configuration")).usage("[options] <resource-group> <gateway-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --gateway-name <gateway-name>", $("the gateway name")).option("-q, --quiet", $("quiet mode, do not ask for delete confirmation")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __3(resourceGroup, gatewayName, options, _) { var subscription, networkManagementClient, applicationGateway, progress; var __frame = { name: "__3", line: 193 }; return __func(_, this, arguments, __3, 3, __frame, function __$__3() {
      ...
      return cli.interaction.promptIfNotGiven($("resource group : "), resourceGroup, __cb(_, __frame, 1, 38, function ___(__0, __2) { resourceGroup = __2;
        return cli.interaction.promptIfNotGiven($("gateway name : "), gatewayName, __cb(_, __frame, 2, 36, function ___(__0, __3) { gatewayName = __3;
          ...
          progress = cli.interaction.progress(util.format($("Looking up the application gateway \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
              ...
              if (!applicationGateway) {
                return _(new Error(util.format($("application gateway \"%s\" not found in the resource group \"%s\""), gatewayName, resourceGroup))); } ; return (function __$__3(_) {



                var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete web application firewall configuration from \"%s\"? [y/n] "), gatewayName), __cb(_, __frame, 26, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -192, 17, function ___(__0, __5) { return (function __$__3(__then) { if (__5) { return _(null); } else { __then(); } ; })(function __$__3() {



                  delete applicationGateway.webApplicationFirewallConfiguration;
                  progress = cli.interaction.progress("Deleting web application firewall configuration"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {

                        return networkManagementClient.applicationGateways.createOrUpdate(resourceGroup, gatewayName, applicationGateway, __cb(_, __frame, 33, 73, function ___(__0, __6) { applicationGateway = __6; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__3() {
  ...
  webApplicationFirewallConfiguration.command("list [resource-group] [gateway-name]").description($("List web application firewall configuration")).usage("[options] <resource-group> <gateway-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-w, --gateway-name <gateway-name>", $("the gateway name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(resourceGroup, gatewayName, options, _) { var subscription, networkManagementClient, applicationGateway, progress, items; var __frame = { name: "__5", line: 277 }; return __func(_, this, arguments, __5, 3, __frame, function __$__5() {
      ...
      progress = cli.interaction.progress(util.format($("Looking up the application gateway \"%s\""), gatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__5() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__5() {
          ...
          items = applicationGateway.webApplicationFirewallConfiguration;
