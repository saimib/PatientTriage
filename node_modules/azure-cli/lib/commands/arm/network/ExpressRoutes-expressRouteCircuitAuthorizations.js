...
exports.init = function(cli) {
  ...
  expressRouteCircuitAuthorizations.command("create [resource-group] [circuit-name] [auth-name] [key]").description($("Create an express route circuit authorization")).usage("[options] <resource-group> <circuit-name> <auth-name> <key>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-c, --circuit-name <circuit-name>", $("the circuit name")).option("-n, --auth-name <auth-name>", $("the auth name")).option("-k, --key <key>", $("sets AuthorizationKey")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __1(resourceGroup, circuitName, authName, key, options, _) { var subscription, networkManagementClient, expressRouteCircuitAuthorization, progress, parameters; var __frame = { name: "__1", line: 48 }; return __func(_, this, arguments, __1, 5, __frame, function __$__1() {
