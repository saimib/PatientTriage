...
__.extend(AppGateways.prototype, {
  ...
  setUrlPathMap: function setUrlPathMap__5(resourceGroup, appGatewayName, urlPathMapName, options, _) { var self, appGateway, urlPathMap, backendHttpSettings, backendAddressPool, __this = this; var __frame = { name: "setUrlPathMap__5", line: 240 }; return __func(_, this, arguments, setUrlPathMap__5, 4, __frame, function __$setUrlPathMap__5() { self = __this;
      ...
      return self.get(resourceGroup, appGatewayName, __cb(_, __frame, 2, 26, function ___(__0, __1) { appGateway = __1;
        ...
        return self._setAppGateway(resourceGroup, appGatewayName, appGateway, options, __cb(_, __frame, 28, 9, function __$setUrlPathMap__5() { _(); }, true)); }, true)); }); },


  listUrlPathMaps: function listUrlPathMaps__6(resourceGroup, appGatewayName, options, _) { var self, appGateway, __this = this; var __frame = { name: "listUrlPathMaps__6", line: 271 }; return __func(_, this, arguments, listUrlPathMaps__6, 3, __frame, function __$listUrlPathMaps__6() { self = __this;
  ...
  showUrlPathMap: function showUrlPathMap__7(resourceGroup, appGatewayName, urlPathMapName, options, _) { var self, appGateway, urlPathMap, __this = this; var __frame = { name: "showUrlPathMap__7", line: 282 }; return __func(_, this, arguments, showUrlPathMap__7, 4, __frame, function __$showUrlPathMap__7() { self = __this;
  ...
  removeUrlPathMap: function removeUrlPathMap__8(resourceGroup, appGatewayName, urlPathMapName, options, _) { var self, appGateway, index, __this = this; var __frame = { name: "removeUrlPathMap__8", line: 297 }; return __func(_, this, arguments, removeUrlPathMap__8, 4, __frame, function __$removeUrlPathMap__8() { self = __this;
      ...
      return self.get(resourceGroup, appGatewayName, __cb(_, __frame, 2, 26, function ___(__0, __2) { appGateway = __2;
        ...
        if ((index === -1)) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete url path map \"%s\"? [y/n] "), urlPathMapName), __cb(_, __frame, 12, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -296, 17, function ___(__0, __3) { return (function __$removeUrlPathMap__8(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$removeUrlPathMap__8() {
  ...
  addMapRule: function addMapRule__9(resourceGroup, appGatewayName, ruleName, options, _) { var self, appGateway, urlPathMap, backendHttpSettings, backendAddressPool, rule, __this = this; var __frame = { name: "addMapRule__9", line: 316 }; return __func(_, this, arguments, addMapRule__9, 4, __frame, function __$addMapRule__9() { self = __this;
      ...
      return self.get(resourceGroup, appGatewayName, __cb(_, __frame, 2, 26, function ___(__0, __1) { appGateway = __1;
        ...
        return self._setAppGateway(resourceGroup, appGatewayName, appGateway, options, __cb(_, __frame, 33, 9, function __$addMapRule__9() { _(); }, true)); }, true)); }); },


  setMapRule: function setMapRule__10(resourceGroup, appGatewayName, ruleName, options, _) { var self, appGateway, urlPathMap, rule, backendHttpSettings, backendAddressPool, __this = this; var __frame = { name: "setMapRule__10", line: 352 }; return __func(_, this, arguments, setMapRule__10, 4, __frame, function __$setMapRule__10() { self = __this;
      ...
      return self.get(resourceGroup, appGatewayName, __cb(_, __frame, 2, 26, function ___(__0, __1) { appGateway = __1;
        ...
        return self._setAppGateway(resourceGroup, appGatewayName, appGateway, options, __cb(_, __frame, 33, 9, function __$setMapRule__10() { _(); }, true)); }, true)); }); },


  listUrlPathMapRules: function listUrlPathMapRules__11(resourceGroup, appGatewayName, urlPathMapName, options, _) { var self, appGateway, urlPathMap, __this = this; var __frame = { name: "listUrlPathMapRules__11", line: 388 }; return __func(_, this, arguments, listUrlPathMapRules__11, 4, __frame, function __$listUrlPathMapRules__11() { self = __this;
  ...
  showUrlPathMapRule: function showUrlPathMapRule__12(resourceGroup, appGatewayName, urlPathMapName, ruleName, options, _) { var self, appGateway, urlPathMap, rule, __this = this; var __frame = { name: "showUrlPathMapRule__12", line: 404 }; return __func(_, this, arguments, showUrlPathMapRule__12, 5, __frame, function __$showUrlPathMapRule__12() { self = __this;
  ...
  removeMapRule: function removeMapRule__13(resourceGroup, appGatewayName, ruleName, options, _) { var self, appGateway, urlPathMap, index, __this = this; var __frame = { name: "removeMapRule__13", line: 424 }; return __func(_, this, arguments, removeMapRule__13, 4, __frame, function __$removeMapRule__13() { self = __this;
      ...
      return self.get(resourceGroup, appGatewayName, __cb(_, __frame, 2, 26, function ___(__0, __2) { appGateway = __2;
        ...
        if ((index === -1)) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete url path map rule \"%s\"? [y/n] "), ruleName), __cb(_, __frame, 17, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -423, 17, function ___(__0, __3) { return (function __$removeMapRule__13(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$removeMapRule__13() {
  ...
  showDisabledRuleGroup: function showDisabledRuleGroup__16(resourceGroup, appGatewayName, options, _) { var self, result, wafConfig, disabledRuleGroup, __this = this; var __frame = { name: "showDisabledRuleGroup__16", line: 519 }; return __func(_, this, arguments, showDisabledRuleGroup__16, 3, __frame, function __$showDisabledRuleGroup__16() { self = __this;
  ...
  listDisabledRuleGroups: function listDisabledRuleGroups__17(resourceGroup, appGatewayName, options, _) { var self, result, wafConfig, __this = this; var __frame = { name: "listDisabledRuleGroups__17", line: 544 }; return __func(_, this, arguments, listDisabledRuleGroups__17, 3, __frame, function __$listDisabledRuleGroups__17() { self = __this;
  ...
  deleteDisabledRuleGroup: function deleteDisabledRuleGroup__18(resourceGroup, appGatewayName, options, _) { var self, result, wafConfig, disabledRuleGroup, progress, __this = this; var __frame = { name: "deleteDisabledRuleGroup__18", line: 561 }; return __func(_, this, arguments, deleteDisabledRuleGroup__18, 3, __frame, function __$deleteDisabledRuleGroup__18() { self = __this;
  ...
  _parseFrontendIp: function _parseFrontendIp__19(resourceGroup, appGatewayName, frontendIpName, options, _) { var self, frontendIp, ipValidationResult, publicIp, subnet, __this = this; var __frame = { name: "_parseFrontendIp__19", line: 820 }; return __func(_, this, arguments, _parseFrontendIp__19, 4, __frame, function __$_parseFrontendIp__19() { self = __this;
      ...
      if (options.publicIpId) {
        ...
        return _(null, frontendIp); } ; return (function __$_parseFrontendIp__19(__then) {
        ...
        if (options.publicIpName) {
          return self.publicIpCrud.get(resourceGroup, options.publicIpName, __cb(_, __frame, 22, 39, function ___(__0, __1) { publicIp = __1;
            ...
            return _(null, frontendIp); }, true)); } else { __then(); } ; })(function __$_parseFrontendIp__19() { return (function __$_parseFrontendIp__19(__then) {
          ...
          if ((options.vnetName && options.subnetName)) {
            return self.subnetCrud.get(resourceGroup, options.vnetName, options.subnetName, __cb(_, __frame, 31, 35, function ___(__0, __2) { subnet = __2;
              ...
              return _(null, frontendIp); }, true)); } else { __then(); } ; })(function __$_parseFrontendIp__19() {
  ...
  _setAppGateway: function _setAppGateway__20(resourceGroup, appGatewayName, appGateway, options, _) { var self, progress, updatedAppGateway, __this = this; var __frame = { name: "_setAppGateway__20", line: 866 }; return __func(_, this, arguments, _setAppGateway__20, 4, __frame, function __$_setAppGateway__20() { self = __this;


      progress = self.interaction.progress(util.format($("Setting long-running configuration for an application gateway %s"), appGatewayName)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$_setAppGateway__20() { return (function __$_setAppGateway__20(__then) {
              ...
              if (options.nowait) {
                ...
                return self.networkManagementClient.applicationGateways.createOrUpdate(resourceGroup, appGatewayName, appGateway, null, __cb(_, __frame, 9, 77, function ___(__0, __2) { updatedAppGateway = __2; __then(); }, true)); } ; })(function __$_setAppGateway__20() { _(null, null, true); }); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$_setAppGateway__20() {


              progress.end(); __then(); }); })(function ___() { __tryCatch(_, function ___() { if (__cont) { __then(); } else { _(__e, __r); }; }); }); }); })(function ___() { __tryCatch(_, function __$_setAppGateway__20() {
