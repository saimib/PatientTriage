...
exports.init = function(cli) {
          ...
          return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 3, 29, function ___(__0, __4) { name = __4;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the express route circuit peering \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
                ...
                if (!expressRouteCircuitPeering) {
                  ...
                  var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete express route circuit peering \"%s\"? [y/n] "), name), __cb(_, __frame, 26, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -293, 17, function ___(__0, __6) { return (function __$__3(__then) { if (__6) {
  ...
  expressRouteCircuitPeerings.command("show [resource-group] [circuit-name] [name]").description($("Show an express route circuit peering")).usage("[options] <resource-group> <circuit-name> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-c, --circuit-name <circuit-name>", $("the circuit name")).option("-n, --name <name>", $("the name of the express route circuit peering")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, circuitName, name, options, _) { var subscription, networkManagementClient, expressRouteCircuitPeering, progress; var __frame = { name: "__4", line: 341 }; return __func(_, this, arguments, __4, 4, __frame, function __$__4() {
  ...
  expressRouteCircuitPeerings.command("list [resource-group] [circuit-name]").description($("List express route circuit peerings")).usage("[options] <resource-group> <circuit-name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-c, --circuit-name <circuit-name>", $("the circuit name")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(resourceGroup, circuitName, options, _) { var subscription, networkManagementClient, expressRouteCircuitPeering, progress; var __frame = { name: "__5", line: 376 }; return __func(_, this, arguments, __5, 3, __frame, function __$__5() {
