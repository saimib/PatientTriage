...
__.extend(VirtualNetworkGateway.prototype, {
  ...
  create: function create__1(resourceGroupName, gatewayName, options, _) { var self, defSubnetName, parameters, gateway, progress, __this = this; var __frame = { name: "create__1", line: 46 }; return __func(_, this, arguments, create__1, 3, __frame, function __$create__1() { self = __this; return (function __$create__1(__then) {
  ...
  set: function set__2(resourceGroupName, gatewayName, options, _) { var self, gateway, __this = this; var __frame = { name: "set__2", line: 103 }; return __func(_, this, arguments, set__2, 3, __frame, function __$set__2() { self = __this;
  ...
  list: function list__3(resourceGroupName, options, _) { var self, gateways, progress, __this = this; var __frame = { name: "list__3", line: 118 }; return __func(_, this, arguments, list__3, 2, __frame, function __$list__3() { self = __this;
  ...
  show: function show__4(resourceGroupName, gatewayName, options, _) { var self, gateway, __this = this; var __frame = { name: "show__4", line: 148 }; return __func(_, this, arguments, show__4, 3, __frame, function __$show__4() { self = __this;
  ...
  delete: function delete__5(resourceGroupName, gatewayName, options, _) { var self, gateway, progress, __this = this; var __frame = { name: "delete__5", line: 155 }; return __func(_, this, arguments, delete__5, 3, __frame, function __$delete__5() { self = __this;
  ...
  get: function get__6(resourceGroupName, gatewayName, _) { var self, progress, gateway, __this = this; var __frame = { name: "get__6", line: 175 }; return __func(_, this, arguments, get__6, 2, __frame, function __$get__6() { self = __this;
  ...
  update: function update__7(resourceGroupName, gatewayName, gateway, _) { var self, progress, __this = this; var __frame = { name: "update__7", line: 192 }; return __func(_, this, arguments, update__7, 3, __frame, function __$update__7() { self = __this;
  ...
  createRootCert: function createRootCert__8(resourceGroupName, gatewayName, certName, options, _) { var self, gateway, certData, rootCert, __this = this; var __frame = { name: "createRootCert__8", line: 206 }; return __func(_, this, arguments, createRootCert__8, 4, __frame, function __$createRootCert__8() { self = __this;
  ...
  deleteRootCert: function deleteRootCert__9(resourceGroupName, gatewayName, certName, options, _) { var self, gateway, index, __this = this; var __frame = { name: "deleteRootCert__9", line: 236 }; return __func(_, this, arguments, deleteRootCert__9, 4, __frame, function __$deleteRootCert__9() { self = __this;
      ...
      return self.get(resourceGroupName, gatewayName, __cb(_, __frame, 3, 23, function ___(__0, __2) { gateway = __2;
        ...
        if ((index === -1)) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete a root certificate \"%s?\" [y/n] "), certName), __cb(_, __frame, 13, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -235, 17, function ___(__0, __3) { return (function __$deleteRootCert__9(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$deleteRootCert__9() {
  ...
  createRevokedCert: function createRevokedCert__10(resourceGroupName, gatewayName, certName, options, _) { var self, gateway, revokedCert, __this = this; var __frame = { name: "createRevokedCert__10", line: 262 }; return __func(_, this, arguments, createRevokedCert__10, 4, __frame, function __$createRevokedCert__10() { self = __this;
  ...
  deleteRevokedCert: function deleteRevokedCert__11(resourceGroupName, gatewayName, certName, options, _) { var self, gateway, index, __this = this; var __frame = { name: "deleteRevokedCert__11", line: 289 }; return __func(_, this, arguments, deleteRevokedCert__11, 4, __frame, function __$deleteRevokedCert__11() { self = __this;
      ...
      return self.get(resourceGroupName, gatewayName, __cb(_, __frame, 3, 23, function ___(__0, __2) { gateway = __2;
        ...
        if ((index === -1)) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete a revoked certificate \"%s?\" [y/n] "), certName), __cb(_, __frame, 13, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -288, 17, function ___(__0, __3) { return (function __$deleteRevokedCert__11(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$deleteRevokedCert__11() {
  ...
  createConnection: function createConnection__12(resourceGroupName, connectionName, options, _) { var self, parameters, connection, progress, __this = this; var __frame = { name: "createConnection__12", line: 315 }; return __func(_, this, arguments, createConnection__12, 3, __frame, function __$createConnection__12() { self = __this;
      ...
      return self._parseConnection(resourceGroupName, parameters, options, true, __cb(_, __frame, 7, 22, function ___(__0, __1) { parameters = __1;

        return self.getConnection(resourceGroupName, connectionName, __cb(_, __frame, 9, 26, function ___(__0, __2) { connection = __2;
          if (connection) {
          ...
          progress = self.interaction.progress(util.format($("Creating gateway connection \"%s\" between \"%s\" and \"%s\""), connectionName, options.vnetGateway1, ((options.vnetGateway2 || options.lnetGateway2) || options.peerName))); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$createConnection__12() {

                return self.networkManagementClient.virtualNetworkGatewayConnections.createOrUpdate(resourceGroupName, connectionName, parameters, __cb(_, __frame, 16, 81, function ___(__0, __3) { connection = __3; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$createConnection__12() {
  ...
  setConnection: function setConnection__13(resourceGroupName, connectionName, options, _) { var self, connection, progress, __this = this; var __frame = { name: "setConnection__13", line: 338 }; return __func(_, this, arguments, setConnection__13, 3, __frame, function __$setConnection__13() { self = __this;
  ...
  listConnections: function listConnections__14(resourceGroupName, options, _) { var self, progress, connections, __this = this; var __frame = { name: "listConnections__14", line: 357 }; return __func(_, this, arguments, listConnections__14, 2, __frame, function __$listConnections__14() { self = __this;
  ...
  showConnection: function showConnection__15(resourceGroupName, connectionName, options, _) { var self, connection, __this = this; var __frame = { name: "showConnection__15", line: 393 }; return __func(_, this, arguments, showConnection__15, 3, __frame, function __$showConnection__15() { self = __this;
  ...
  deleteConnection: function deleteConnection__16(resourceGroupName, connectionName, options, _) { var self, connection, progress, __this = this; var __frame = { name: "deleteConnection__16", line: 399 }; return __func(_, this, arguments, deleteConnection__16, 3, __frame, function __$deleteConnection__16() { self = __this;
      ...
      return self.getConnection(resourceGroupName, connectionName, __cb(_, __frame, 2, 26, function ___(__0, __2) { connection = __2;
        ...
        if (!connection) {
          ...
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return self.interaction.confirm(util.format($("Delete gateway connection \"%s\"? [y/n] "), connectionName), __cb(_, __frame, 8, 44, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -398, 17, function ___(__0, __3) { return (function __$deleteConnection__16(__then) { if (__3) { return _(null); } else { __then(); } ; })(function __$deleteConnection__16() {
  ...
  getConnection: function getConnection__17(resourceGroupName, connectionName, _) { var self, progress, connection, __this = this; var __frame = { name: "getConnection__17", line: 419 }; return __func(_, this, arguments, getConnection__17, 2, __frame, function __$getConnection__17() { self = __this;
  ...
  showConnectionSharedKey: function showConnectionSharedKey__20(resourceGroupName, connectionName, options, _) { var self, connection, sharedKey, __this = this; var __frame = { name: "showConnectionSharedKey__20", line: 478 }; return __func(_, this, arguments, showConnectionSharedKey__20, 3, __frame, function __$showConnectionSharedKey__20() { self = __this;
  ...
  getConnectionSharedKey: function getConnectionSharedKey__21(resourceGroupName, connectionName, _) { var self, progress, sharedKey, __this = this; var __frame = { name: "getConnectionSharedKey__21", line: 496 }; return __func(_, this, arguments, getConnectionSharedKey__21, 2, __frame, function __$getConnectionSharedKey__21() { self = __this;
  ...
  _parseGateway: function _parseGateway__22(resourceGroupName, gateway, options, _) { var self, asn, ipValidationResult, weight, publicip, subnet, localGateway, addrPrefixes, prefixes, __this = this; var __frame = { name: "_parseGateway__22", line: 515 }; return __func(_, this, arguments, _parseGateway__22, 3, __frame, function __$_parseGateway__22() { self = __this;
      ...
      if (options.bgpAsn) {
        asn = parseInt(options.bgpAsn);
        if (isNaN(asn)) {
          return _(new Error(util.format($("BGP settings ASN \"%s\" is not valid. It must be a number"), options.bgpAsn))); } ;
      ...
      if (options.bgpPeeringAddress) {
        ...
        ipValidationResult = self.vnetUtil.parseIPv4(options.bgpPeeringAddress);
        if (ipValidationResult.error) {
          return _(new Error(util.format($("BGP peering address \"%s\" is not valid"), options.bgpPeeringAddress))); } ;

        gateway.bgpSettings.bgpPeeringAddress = options.bgpPeeringAddress; } ;


      if (options.bgpPeerWeight) {
        weight = parseInt(options.bgpPeerWeight);
        if (isNaN(weight)) {
          return _(new Error(util.format($("BGP peering weight \"%s\" is not valid. It must be a number"), options.bgpPeerWeight))); } ;

        if (!gateway.bgpSettings) {
          gateway.bgpSettings = { }; } ;

        gateway.bgpSettings.peerWeight = weight; } ; return (function __$_parseGateway__22(__then) {
        ...
        if (options.publicIpId) {
          ...
          gateway.ipConfigurations[0].publicIPAddress = {
            ...
            if (options.publicIpName) {
              return self.publicIpCrud.get(resourceGroupName, options.publicIpName, __cb(_, __frame, 61, 39, function ___(__0, __1) { publicip = __1;
                if (!publicip) {
          ...
          if (options.subnetId) {
            ...
            gateway.ipConfigurations[0].subnet = {
              ...
              if ((options.vnetName && options.subnetName)) {
                return self.subnetCrud.get(resourceGroupName, options.vnetName, options.subnetName, __cb(_, __frame, 78, 35, function ___(__0, __2) { subnet = __2;
                  if (!subnet) {
              ...
              if (utils.argHasValue(options.defaultSiteId)) {
                ...
                if (options.defaultSiteName) { return (function __$_parseGateway__22(__then) {
                    if (utils.argHasValue(options.defaultSiteName)) {
                      return self.lnetGatewayCrud.get(resourceGroupName, options.defaultSiteName, __cb(_, __frame, 100, 48, function ___(__0, __3) { localGateway = __3;
                        if (!localGateway) {
  ...
  _parseConnection: function _parseConnection__23(resourceGroupName, connection, options, useDefaults, _) { var self, resGroupGateway1, gateway1, vnetGateway1Info, resGroupGateway2, gateway2, vnetGateway2Info, resGroupLnetGateway2, lnet2, resGroupPeer, peer, __this = this; var __frame = { name: "_parseConnection__23", line: 665 }; return __func(_, this, arguments, _parseConnection__23, 4, __frame, function __$_parseConnection__23() { self = __this;
      ...
      if ((((useDefaults && !options.vnetGateway2) && !options.lnetGateway2) && !options.peerName)) {
        return _(new Error($("You must specify connected entity with --vnet-gateway2 or --lnet-gateway2 or --peer-name option"))); } ;
      ...
      if (options.tags) {
        ...
        if (options.vnetGateway1) {
          ...
          return self.get(resGroupGateway1, options.vnetGateway1, __cb(_, __frame, 35, 26, function ___(__0, __1) { gateway1 = __1;
            ...
            connection.virtualNetworkGateway1 = gateway1; __then(); }, true)); } else { return (function __$_parseConnection__23(__then) {
            if ((!useDefaults && !connection.virtualNetworkGateway1.ipConfigurations)) {
              vnetGateway1Info = resourceUtils.getResourceInformation(connection.virtualNetworkGateway1.id);
              return self.get(vnetGateway1Info.resourceGroup, vnetGateway1Info.resourceName, __cb(_, __frame, 40, 47, function ___(__0, __2) { connection.virtualNetworkGateway1 = __2; __then(); }, true)); } else { __then(); } ; })(__then); } ; })(function __$_parseConnection__23() { return (function __$_parseConnection__23(__then) {
          ...
          if (options.vnetGateway2) {
            ...
            return self.get(resGroupGateway2, options.vnetGateway2, __cb(_, __frame, 48, 26, function ___(__0, __3) { gateway2 = __3;
              ...
              connection.virtualNetworkGateway2 = gateway2; __then(); }, true)); } else { return (function __$_parseConnection__23(__then) {
              if ((!useDefaults && !connection.virtualNetworkGateway2.ipConfigurations)) {
                vnetGateway2Info = resourceUtils.getResourceInformation(connection.virtualNetworkGateway2.id);
                return self.get(vnetGateway2Info.resourceGroup, vnetGateway2Info.resourceName, __cb(_, __frame, 53, 47, function ___(__0, __4) { connection.virtualNetworkGateway2 = __4; __then(); }, true)); } else { __then(); } ; })(__then); } ; })(function __$_parseConnection__23() { return (function __$_parseConnection__23(__then) {
            ...
            if (options.lnetGateway2) {
              ...
              return self.lnetGatewayCrud.get(resGroupLnetGateway2, options.lnetGateway2, __cb(_, __frame, 61, 39, function ___(__0, __5) { lnet2 = __5;
                ...
                connection.localNetworkGateway2 = lnet2; __then(); }, true)); } else { __then(); } ; })(function __$_parseConnection__23() { return (function __$_parseConnection__23(__then) {


              if (options.peerName) {
                resGroupPeer = (options.peerGroup || resourceGroupName);
                if (!options.peerGroup) {
                  self.output.warn(util.format($("Using resource group for connected peer: %s"), resGroupPeer)); } ;


                return self.expressRouteCrud.getCircuit(resGroupPeer, options.peerName, __cb(_, __frame, 72, 39, function ___(__0, __6) { peer = __6;
                  if (!peer) { return _(new Error(util.format($("An express route circuit with name \"%s\" not found in the resource group \"%s\""), options.peerName, resGroupPeer))); } ;
                  connection.peer = peer; __then(); }, true)); } else { __then(); } ; })(function __$_parseConnection__23() {
