...
exports.init = function(cli) {
  ...
  loadBalancers.command("create [resource-group] [name] [location]").description($("Create a load balancer")).usage("[options] <resource-group> <name> <location>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the load balancer")).option("-l, --location <location>", $("the location")).option("-t, --tags [tags]", $(constants.help.tags.create)).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __1(resourceGroup, name, location, options, _) { var subscription, networkManagementClient, loadBalancer, progress, parameters; var __frame = { name: "__1", line: 48 }; return __func(_, this, arguments, __1, 4, __frame, function __$__1() {
          ...
          return cli.interaction.promptIfNotGiven($("location : "), location, __cb(_, __frame, 3, 41, function ___(__0, __3) { options.location = __3;
            ...
            progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                ...
                progress = cli.interaction.progress(util.format($("Creating load balancer \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__1() {
                      ...
                      return networkManagementClient.loadBalancers.createOrUpdate(resourceGroup, name, parameters, __cb(_, __frame, 38, 61, function ___(__0, __5) { loadBalancer = __5; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__1() {
  ...
  loadBalancers.command("set [resource-group] [name]").description($("Update a load balancer")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the load balancer")).option("-t, --tags [tags]", $(constants.help.tags.create)).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __2(resourceGroup, name, options, _) { var subscription, networkManagementClient, loadBalancer, progress, parameters; var __frame = { name: "__2", line: 101 }; return __func(_, this, arguments, __2, 3, __frame, function __$__2() {
        ...
        return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 2, 29, function ___(__0, __2) { name = __2;
          ...
          progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
              ...
              progress = cli.interaction.progress(util.format($("Updating load balancer \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
                    ...
                    return networkManagementClient.loadBalancers.createOrUpdate(resourceGroup, name, parameters, __cb(_, __frame, 33, 61, function ___(__0, __4) { loadBalancer = __4; _(null, null, true); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__2() {
        ...
        return cli.interaction.promptIfNotGiven($("name : "), name, __cb(_, __frame, 2, 29, function ___(__0, __3) { name = __3;
          ...
          progress = cli.interaction.progress(util.format($("Looking up the load balancer \"%s\""), name)); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__3() {
              ...
              if (!loadBalancer) {
                ...
                var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return cli.interaction.confirm(util.format($("Delete load balancer \"%s\"? [y/n] "), name), __cb(_, __frame, 25, 45, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -148, 17, function ___(__0, __5) { return (function __$__3(__then) { if (__5) {
  ...
  loadBalancers.command("show [resource-group] [name]").description($("Show a load balancer")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("the name of the resource group")).option("-n, --name <name>", $("the name of the load balancer")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __4(resourceGroup, name, options, _) { var subscription, networkManagementClient, loadBalancer, progress; var __frame = { name: "__4", line: 194 }; return __func(_, this, arguments, __4, 3, __frame, function __$__4() {
  ...
  loadBalancers.command("list [resource-group]").description($("List load balancers")).usage("[options] <resource-group>").option("-g, --resource-group [resource-group]", $("the name of the resource group")).option("-s, --subscription <subscription>", $("the subscription identifier")).execute(function __5(resourceGroup, options, _) { var subscription, networkManagementClient, loadBalancer, progress; var __frame = { name: "__5", line: 227 }; return __func(_, this, arguments, __5, 2, __frame, function __$__5() {
