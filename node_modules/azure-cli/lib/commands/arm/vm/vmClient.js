...
__.extend(VMClient.prototype, {
  ...
  addSecret: function addSecret__49(params, options, _) { var subscription, serviceClients, virtualMachine, vmResult, sourceVaultObj, certUrlObj, __this = this; var __frame = { name: "addSecret__49", line: 2194 }; return __func(_, this, arguments, addSecret__49, 2, __frame, function __$addSecret__49() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
  ...
  deleteSecret: function deleteSecret__50(params, options, _) { var subscription, serviceClients, virtualMachine, vmResult, i0, i, j, __this = this; var __frame = { name: "deleteSecret__50", line: 2219 }; return __func(_, this, arguments, deleteSecret__50, 2, __frame, function __$deleteSecret__50() {
      subscription = profile.current.getSubscription(__this.subscription);
      serviceClients = __this._getServiceClients(subscription);
      virtualMachine = new VirtualMachine(__this.cli, serviceClients);
      return virtualMachine.getVM(params.group, params.name, __cb(_, __frame, 4, 34, function ___(__0, __1) { vmResult = __1;
