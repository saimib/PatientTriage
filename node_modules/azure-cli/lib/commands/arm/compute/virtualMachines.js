...
exports.init = function(cli) {
  ...
  virtualMachinesCreateOrUpdatecreateOrUpdateParameters2.command("patch").description($("Command to patch virtualMachinesCreateOrUpdate parameter JSON file.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--operation <operation>", $("The JSON patch operation: add, remove, or replace.")).option("--path <path>", $("The JSON data path, e.g.: \"foo/1\".")).option("--value <value>", $("The JSON value.")).option("--parse", $("Parse the JSON value to object.")).execute(function __4(options, _) { var fileContent, parametersObj, updatedContent; var __frame = { name: "__4", line: 1326 }; return __func(_, this, arguments, __4, 1, __frame, function __$__4() {
  ...
  setparametersCreateOrUpdateVirtualMachinesDisks0IVd1.command("set").description($("Set disks in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"disks\" : {\r\n             \"name\":\"\",\r\n             \"statuses\":[\r\n               {\r\n                 \"code\":\"\",\r\n                 \"level\":null,\r\n                 \"displayStatus\":\"\",\r\n                 \"message\":\"\",\r\n                 \"time\":null\r\n               }\r\n             ]\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--value <value>", $("The input string value for the indexed item.")).option("--parse", $("Parse the input string, i.e. str, for parameters to a JSON object, e.g. JSON.parse(str).")).option("--name <name>", $("Set the name value.")).option("--statuses <statuses>", $("Set the statuses value.")).execute(function __85(options, _) { var fileContent, parametersObj, error, paramPath, updatedContent; var __frame = { name: "__85", line: 7081 }; return __func(_, this, arguments, __85, 1, __frame, function __$__85() {
  ...
  deleteparametersCreateOrUpdateVirtualMachinesDisks1IVd1.command("delete").description($("Remove disks in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"disks\" : {\r\n             \"name\":\"\",\r\n             \"statuses\":[\r\n               {\r\n                 \"code\":\"\",\r\n                 \"level\":null,\r\n                 \"displayStatus\":\"\",\r\n                 \"message\":\"\",\r\n                 \"time\":null\r\n               }\r\n             ]\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--name", $("Remove the name value.")).option("--statuses", $("Remove the statuses value.")).execute(function __86(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__86", line: 7150 }; return __func(_, this, arguments, __86, 1, __frame, function __$__86() {
      ...
      return cli.output.verbose(JSON.stringify(options), __cb(_, __frame, 1, 15, function __$__86() { return (function __$__86(__then) {
          ...
          options.operation = "remove";
          options.path = ("/instanceView/disks" + ((options.index ? (("/" + options.index)) : "")));
          anySubItem = ((false || options.name) || options.statuses);
          if (anySubItem) {
            subItemPath = null;
            if (options.name) {
              subItemPath = (options.path + "/name");
  ...
  deleteparametersCreateOrUpdateVirtualMachinesStatuses1IVdIs3.command("delete").description($("Remove disks-statuses in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"statuses\" : {\r\n             \"code\":\"\",\r\n             \"level\":null,\r\n             \"displayStatus\":\"\",\r\n             \"message\":\"\",\r\n             \"time\":null\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--disks-index <disks-index>", $("Indexer: disks-index.")).option("--code", $("Remove the code value.")).option("--level", $("Remove the level value.")).option("--display-status", $("Remove the display-status value.")).option("--message", $("Remove the message value.")).option("--time", $("Remove the time value.")).execute(function __88(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__88", line: 7316 }; return __func(_, this, arguments, __88, 1, __frame, function __$__88() {
  ...
  setparametersCreateOrUpdateVirtualMachinesExtensions0IVe1.command("set").description($("Set extensions in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"extensions\" : {\r\n             \"name\":\"\",\r\n             \"type\":\"\",\r\n             \"typeHandlerVersion\":\"\",\r\n             \"substatuses\":[\r\n               {\r\n                 \"code\":\"\",\r\n                 \"level\":null,\r\n                 \"displayStatus\":\"\",\r\n                 \"message\":\"\",\r\n                 \"time\":null\r\n               }\r\n             ],\r\n             \"statuses\":[\r\n               {\r\n                 \"code\":\"\",\r\n                 \"level\":null,\r\n                 \"displayStatus\":\"\",\r\n                 \"message\":\"\",\r\n                 \"time\":null\r\n               }\r\n             ]\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--value <value>", $("The input string value for the indexed item.")).option("--parse", $("Parse the input string, i.e. str, for parameters to a JSON object, e.g. JSON.parse(str).")).option("--name <name>", $("Set the name value.")).option("--type <type>", $("Set the type value.")).option("--type-handler-version <typeHandlerVersion>", $("Set the type-handler-version value.")).option("--substatuses <substatuses>", $("Set the substatuses value.")).option("--statuses <statuses>", $("Set the statuses value.")).execute(function __89(options, _) { var fileContent, parametersObj, error, paramPath, updatedContent; var __frame = { name: "__89", line: 7387 }; return __func(_, this, arguments, __89, 1, __frame, function __$__89() {
  ...
  deleteparametersCreateOrUpdateVirtualMachinesExtensions1IVe1.command("delete").description($("Remove extensions in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"extensions\" : {\r\n             \"name\":\"\",\r\n             \"type\":\"\",\r\n             \"typeHandlerVersion\":\"\",\r\n             \"substatuses\":[\r\n               {\r\n                 \"code\":\"\",\r\n                 \"level\":null,\r\n                 \"displayStatus\":\"\",\r\n                 \"message\":\"\",\r\n                 \"time\":null\r\n               }\r\n             ],\r\n             \"statuses\":[\r\n               {\r\n                 \"code\":\"\",\r\n                 \"level\":null,\r\n                 \"displayStatus\":\"\",\r\n                 \"message\":\"\",\r\n                 \"time\":null\r\n               }\r\n             ]\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--name", $("Remove the name value.")).option("--type", $("Remove the type value.")).option("--type-handler-version", $("Remove the type-handler-version value.")).option("--substatuses", $("Remove the substatuses value.")).option("--statuses", $("Remove the statuses value.")).execute(function __90(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__90", line: 7492 }; return __func(_, this, arguments, __90, 1, __frame, function __$__90() {
  ...
  deleteparametersCreateOrUpdateVirtualMachinesSubstatuses1IVeIs4.command("delete").description($("Remove substatuses in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"substatuses\" : {\r\n             \"code\":\"\",\r\n             \"level\":null,\r\n             \"displayStatus\":\"\",\r\n             \"message\":\"\",\r\n             \"time\":null\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--extensions-index <extensions-index>", $("Indexer: extensions-index.")).option("--code", $("Remove the code value.")).option("--level", $("Remove the level value.")).option("--display-status", $("Remove the display-status value.")).option("--message", $("Remove the message value.")).option("--time", $("Remove the time value.")).execute(function __92(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__92", line: 7670 }; return __func(_, this, arguments, __92, 1, __frame, function __$__92() {
  ...
  setparametersCreateOrUpdateVirtualMachinesStatuses0IVeIs5.command("set").description($("Set extensions-statuses in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"statuses\" : {\r\n             \"code\":\"\",\r\n             \"level\":null,\r\n             \"displayStatus\":\"\",\r\n             \"message\":\"\",\r\n             \"time\":null\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--extensions-index <extensions-index>", $("Indexer: extensions-index.")).option("--value <value>", $("The input string value for the indexed item.")).option("--parse", $("Parse the input string, i.e. str, for parameters to a JSON object, e.g. JSON.parse(str).")).option("--code <code>", $("Set the code value.")).option("--level <level>", $("Set the level value.")).option("--display-status <displayStatus>", $("Set the display-status value.")).option("--message <message>", $("Set the message value.")).option("--time <time>", $("Set the time value.")).execute(function __93(options, _) { var fileContent, parametersObj, error, paramPath, updatedContent; var __frame = { name: "__93", line: 7742 }; return __func(_, this, arguments, __93, 1, __frame, function __$__93() {
  ...
  deleteparametersCreateOrUpdateVirtualMachinesStatuses1IVeIs5.command("delete").description($("Remove extensions-statuses in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"statuses\" : {\r\n             \"code\":\"\",\r\n             \"level\":null,\r\n             \"displayStatus\":\"\",\r\n             \"message\":\"\",\r\n             \"time\":null\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--extensions-index <extensions-index>", $("Indexer: extensions-index.")).option("--code", $("Remove the code value.")).option("--level", $("Remove the level value.")).option("--display-status", $("Remove the display-status value.")).option("--message", $("Remove the message value.")).option("--time", $("Remove the time value.")).execute(function __94(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__94", line: 7848 }; return __func(_, this, arguments, __94, 1, __frame, function __$__94() {
  ...
  deleteparametersCreateOrUpdateVirtualMachinesBootDiagnostics1IVbD1.command("delete").description($("Remove instance-view-boot-diagnostics in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"bootDiagnostics\" : {\r\n             \"consoleScreenshotBlobUri\":\"\",\r\n             \"serialConsoleLogBlobUri\":\"\"\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--console-screenshot-blob-uri", $("Remove the console-screenshot-blob-uri value.")).option("--serial-console-log-blob-uri", $("Remove the serial-console-log-blob-uri value.")).execute(function __96(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__96", line: 7978 }; return __func(_, this, arguments, __96, 1, __frame, function __$__96() {
  ...
  deleteparametersCreateOrUpdateVirtualMachinesStatuses1IVs6.command("delete").description($("Remove instance-view-statuses in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"statuses\" : {\r\n             \"code\":\"\",\r\n             \"level\":null,\r\n             \"displayStatus\":\"\",\r\n             \"message\":\"\",\r\n             \"time\":null\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--code", $("Remove the code value.")).option("--level", $("Remove the level value.")).option("--display-status", $("Remove the display-status value.")).option("--message", $("Remove the message value.")).option("--time", $("Remove the time value.")).execute(function __98(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__98", line: 8142 }; return __func(_, this, arguments, __98, 1, __frame, function __$__98() {
  ...
  deleteparametersCreateOrUpdateVirtualMachinesResources1R1.command("delete").description($("Remove resources in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"resources\" : {\r\n             \"forceUpdateTag\":\"\",\r\n             \"publisher\":\"\",\r\n             \"virtualMachineExtensionType\":\"\",\r\n             \"typeHandlerVersion\":\"\",\r\n             \"autoUpgradeMinorVersion\":null,\r\n             \"settings\":{\r\n             },\r\n             \"protectedSettings\":{\r\n             },\r\n             \"provisioningState\":\"\",\r\n             \"instanceView\":{\r\n               \"name\":\"\",\r\n               \"type\":\"\",\r\n               \"typeHandlerVersion\":\"\",\r\n               \"substatuses\":[\r\n                 {\r\n                   \"code\":\"\",\r\n                   \"level\":null,\r\n                   \"displayStatus\":\"\",\r\n                   \"message\":\"\",\r\n                   \"time\":null\r\n                 }\r\n               ],\r\n               \"statuses\":[\r\n                 {\r\n                   \"code\":\"\",\r\n                   \"level\":null,\r\n                   \"displayStatus\":\"\",\r\n                   \"message\":\"\",\r\n                   \"time\":null\r\n                 }\r\n               ]\r\n             },\r\n             \"id\":null,\r\n             \"name\":null,\r\n             \"type\":null,\r\n             \"location\":\"\",\r\n             \"tags\":{\r\n             }\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--force-update-tag", $("Remove the force-update-tag value.")).option("--publisher", $("Remove the publisher value.")).option("--virtual-machine-extension-type", $("Remove the virtual-machine-extension-type value.")).option("--type-handler-version", $("Remove the type-handler-version value.")).option("--auto-upgrade-minor-version", $("Remove the auto-upgrade-minor-version value.")).option("--settings", $("Remove the settings value.")).option("--protected-settings", $("Remove the protected-settings value.")).option("--provisioning-state", $("Remove the provisioning-state value.")).option("--instance-view", $("Remove the instance-view value.")).option("--id", $("Remove the id value.")).option("--name", $("Remove the name value.")).option("--type", $("Remove the type value.")).option("--location", $("Remove the location value.")).option("--tags", $("Remove the tags value.")).execute(function __100(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__100", line: 8436 }; return __func(_, this, arguments, __100, 1, __frame, function __$__100() {
  ...
  setparametersCreateOrUpdateVirtualMachinesInstanceView0RIiV2.command("set").description($("Set resources-instance-view in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"instanceView\" : {\r\n             \"name\":\"\",\r\n             \"type\":\"\",\r\n             \"typeHandlerVersion\":\"\",\r\n             \"substatuses\":[\r\n               {\r\n                 \"code\":\"\",\r\n                 \"level\":null,\r\n                 \"displayStatus\":\"\",\r\n                 \"message\":\"\",\r\n                 \"time\":null\r\n               }\r\n             ],\r\n             \"statuses\":[\r\n               {\r\n                 \"code\":\"\",\r\n                 \"level\":null,\r\n                 \"displayStatus\":\"\",\r\n                 \"message\":\"\",\r\n                 \"time\":null\r\n               }\r\n             ]\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--resources-index <resources-index>", $("Indexer: resources-index.")).option("--parse", $("Parse the input string, i.e. str, for parameters to a JSON object, e.g. JSON.parse(str).")).option("--name <name>", $("Set the name value.")).option("--type <type>", $("Set the type value.")).option("--type-handler-version <typeHandlerVersion>", $("Set the type-handler-version value.")).option("--substatuses <substatuses>", $("Set the substatuses value.")).option("--statuses <statuses>", $("Set the statuses value.")).execute(function __101(options, _) { var fileContent, parametersObj, error, paramPath, updatedContent; var __frame = { name: "__101", line: 8542 }; return __func(_, this, arguments, __101, 1, __frame, function __$__101() {
  ...
  deleteparametersCreateOrUpdateVirtualMachinesInstanceView1RIiV2.command("delete").description($("Remove resources-instance-view in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"instanceView\" : {\r\n             \"name\":\"\",\r\n             \"type\":\"\",\r\n             \"typeHandlerVersion\":\"\",\r\n             \"substatuses\":[\r\n               {\r\n                 \"code\":\"\",\r\n                 \"level\":null,\r\n                 \"displayStatus\":\"\",\r\n                 \"message\":\"\",\r\n                 \"time\":null\r\n               }\r\n             ],\r\n             \"statuses\":[\r\n               {\r\n                 \"code\":\"\",\r\n                 \"level\":null,\r\n                 \"displayStatus\":\"\",\r\n                 \"message\":\"\",\r\n                 \"time\":null\r\n               }\r\n             ]\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--resources-index <resources-index>", $("Indexer: resources-index.")).option("--name", $("Remove the name value.")).option("--type", $("Remove the type value.")).option("--type-handler-version", $("Remove the type-handler-version value.")).option("--substatuses", $("Remove the substatuses value.")).option("--statuses", $("Remove the statuses value.")).execute(function __102(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__102", line: 8643 }; return __func(_, this, arguments, __102, 1, __frame, function __$__102() {
  ...
  deleteparametersCreateOrUpdateVirtualMachinesSubstatuses1RIiVs7.command("delete").description($("Remove instance-view-substatuses in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"substatuses\" : {\r\n             \"code\":\"\",\r\n             \"level\":null,\r\n             \"displayStatus\":\"\",\r\n             \"message\":\"\",\r\n             \"time\":null\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--resources-index <resources-index>", $("Indexer: resources-index.")).option("--code", $("Remove the code value.")).option("--level", $("Remove the level value.")).option("--display-status", $("Remove the display-status value.")).option("--message", $("Remove the message value.")).option("--time", $("Remove the time value.")).execute(function __104(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__104", line: 8821 }; return __func(_, this, arguments, __104, 1, __frame, function __$__104() {
  ...
  setparametersCreateOrUpdateVirtualMachinesStatuses0RIiVs8.command("set").description($("Set instance-view-statuses in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"statuses\" : {\r\n             \"code\":\"\",\r\n             \"level\":null,\r\n             \"displayStatus\":\"\",\r\n             \"message\":\"\",\r\n             \"time\":null\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--resources-index <resources-index>", $("Indexer: resources-index.")).option("--value <value>", $("The input string value for the indexed item.")).option("--parse", $("Parse the input string, i.e. str, for parameters to a JSON object, e.g. JSON.parse(str).")).option("--code <code>", $("Set the code value.")).option("--level <level>", $("Set the level value.")).option("--display-status <displayStatus>", $("Set the display-status value.")).option("--message <message>", $("Set the message value.")).option("--time <time>", $("Set the time value.")).execute(function __105(options, _) { var fileContent, parametersObj, error, paramPath, updatedContent; var __frame = { name: "__105", line: 8893 }; return __func(_, this, arguments, __105, 1, __frame, function __$__105() {
  ...
  deleteparametersCreateOrUpdateVirtualMachinesStatuses1RIiVs8.command("delete").description($("Remove instance-view-statuses in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"statuses\" : {\r\n             \"code\":\"\",\r\n             \"level\":null,\r\n             \"displayStatus\":\"\",\r\n             \"message\":\"\",\r\n             \"time\":null\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--resources-index <resources-index>", $("Indexer: resources-index.")).option("--code", $("Remove the code value.")).option("--level", $("Remove the level value.")).option("--display-status", $("Remove the display-status value.")).option("--message", $("Remove the message value.")).option("--time", $("Remove the time value.")).execute(function __106(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__106", line: 8999 }; return __func(_, this, arguments, __106, 1, __frame, function __$__106() {
  ...
  deleteparametersCreateOrUpdateVirtualMachinesIdentity1I1.command("delete").description($("Remove identity in config string or files, e.g. \r\n         {\r\n           ...\r\n           \"identity\" : {\r\n             \"principalId\":\"\",\r\n             \"tenantId\":\"\",\r\n             \"type\":null\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--principal-id", $("Remove the principal-id value.")).option("--tenant-id", $("Remove the tenant-id value.")).option("--type", $("Remove the type value.")).execute(function __108(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__108", line: 9142 }; return __func(_, this, arguments, __108, 1, __frame, function __$__108() {
  ...
  virtualMachinesPerformMaintenance.command("perform-maintenance [resource-group] [vm-name]").description($("The operation to perform maintenance on a virtual machine.")).usage("[options] <resource-group> <vm-name>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --vm-name <vm-name>", $("vm-name")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __109(resourceGroup, vMName, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__109", line: 9201 }; return __func(_, this, arguments, __109, 3, __frame, function __$__109() { return (function __$__109(__then) {
        ...
        if (!resourceGroup) {
          return cli.interaction.promptIfNotGiven($("resource-group : "), resourceGroup, __cb(_, __frame, 2, 38, function ___(__0, __1) { resourceGroup = __1; __then(); }, true)); } else { __then(); } ; })(function __$__109() {


        cli.output.verbose(("resourceGroup = " + resourceGroup)); return (function __$__109(__then) {
          if (!vMName) {
            return cli.interaction.promptIfNotGiven($("vm-name : "), vMName, __cb(_, __frame, 7, 31, function ___(__0, __2) { vMName = __2; __then(); }, true)); } else { __then(); } ; })(function __$__109() {
  ...
  virtualMachinesRedeploy.command("redeploy [resource-group] [vm-name]").description($("The operation to redeploy a virtual machine.")).usage("[options] <resource-group> <vm-name>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --vm-name <vm-name>", $("vm-name")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __110(resourceGroup, vMName, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__110", line: 9232 }; return __func(_, this, arguments, __110, 3, __frame, function __$__110() { return (function __$__110(__then) {
        ...
        if (!resourceGroup) {
          return cli.interaction.promptIfNotGiven($("resource-group : "), resourceGroup, __cb(_, __frame, 2, 38, function ___(__0, __1) { resourceGroup = __1; __then(); }, true)); } else { __then(); } ; })(function __$__110() {


        cli.output.verbose(("resourceGroup = " + resourceGroup)); return (function __$__110(__then) {
          if (!vMName) {
            return cli.interaction.promptIfNotGiven($("vm-name : "), vMName, __cb(_, __frame, 7, 31, function ___(__0, __2) { vMName = __2; __then(); }, true)); } else { __then(); } ; })(function __$__110() {
  ...
  virtualMachinesRunCommand.command("run-command [resource-group] [vm-name] [parameters]").description($("Run command on the VM.")).usage("[options] <resource-group> <vm-name> <parameters>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --vm-name <vm-name>", $("vm-name")).option("-p, --parameters <parameters>", $("A string of parameters in JSON format")).option("--parameter-file <parameter-file>", $("The text file that contains input parameter object in JSON format")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __111(resourceGroup, vMName, parameters, options, _) { var parametersObj, fileContent, subscription, computeManagementClient, result; var __frame = { name: "__111", line: 9276 }; return __func(_, this, arguments, __111, 4, __frame, function __$__111() { return (function __$__111(__then) {
        ...
        if (!resourceGroup) {
          return cli.interaction.promptIfNotGiven($("resource-group : "), resourceGroup, __cb(_, __frame, 2, 38, function ___(__0, __1) { resourceGroup = __1; __then(); }, true)); } else { __then(); } ; })(function __$__111() {


        cli.output.verbose(("resourceGroup = " + resourceGroup)); return (function __$__111(__then) {
          if (!vMName) {
            return cli.interaction.promptIfNotGiven($("vm-name : "), vMName, __cb(_, __frame, 7, 31, function ___(__0, __2) { vMName = __2; __then(); }, true)); } else { __then(); } ; })(function __$__111() {
  ...
  virtualMachinesRunCommandrunCommandParameters2.command("create").description($("Generate virtualMachinesRunCommand parameter string or files.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).execute(function __112(options, _) { var filePath; var __frame = { name: "__112", line: 9311 }; return __func(_, this, arguments, __112, 1, __frame, function __$__112() {




      return cli.output.verbose("{\"commandId\":\"\",\"parameters\":[{\"name\":\"\",\"value\":\"\"}]}", __cb(_, __frame, 1, 15, function __$__112() {
  ...
  virtualMachinesRunCommandrunCommandParameters2.command("patch").description($("Command to patch virtualMachinesRunCommand parameter JSON file.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--operation <operation>", $("The JSON patch operation: add, remove, or replace.")).option("--path <path>", $("The JSON data path, e.g.: \"foo/1\".")).option("--value <value>", $("The JSON value.")).option("--parse", $("Parse the JSON value to object.")).execute(function __113(options, _) { var fileContent, parametersObj, updatedContent; var __frame = { name: "__113", line: 9331 }; return __func(_, this, arguments, __113, 1, __frame, function __$__113() {
      ...
      return cli.output.verbose(options.parameterFile, __cb(_, __frame, 1, 15, function __$__113() {
        cli.output.verbose(options.operation);
        cli.output.verbose(options.path);
        cli.output.verbose(options.value);
        cli.output.verbose(options.parse);
  ...
  setparametersRunCommandVirtualMachinesRunCommandInput01.command("set").description($("Set run-command-input in run-command-parameters string or files, e.g. \r\n{\r\n  \"commandId\":\"\",\r\n  \"parameters\":[\r\n    {\r\n      \"name\":\"\",\r\n      \"value\":\"\"\r\n    }\r\n  ]\r\n}\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--parse", $("Parse the input string, i.e. str, for parameters to a JSON object, e.g. JSON.parse(str).")).option("--command-id <commandId>", $("Set the command-id value.")).option("--parameters <parameters>", $("Set the parameters value.")).execute(function __114(options, _) { var fileContent, parametersObj, error, paramPath, updatedContent; var __frame = { name: "__114", line: 9381 }; return __func(_, this, arguments, __114, 1, __frame, function __$__114() {
  ...
  deleteparametersRunCommandVirtualMachinesRunCommandInput11.command("delete").description($("Remove run-command-input in run-command-parameters string or files, e.g. \r\n{\r\n  \"commandId\":\"\",\r\n  \"parameters\":[\r\n    {\r\n      \"name\":\"\",\r\n      \"value\":\"\"\r\n    }\r\n  ]\r\n}\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--command-id", $("Remove the command-id value.")).option("--parameters", $("Remove the parameters value.")).execute(function __115(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__115", line: 9445 }; return __func(_, this, arguments, __115, 1, __frame, function __$__115() {
      ...
      return cli.output.verbose(JSON.stringify(options), __cb(_, __frame, 1, 15, function __$__115() { return (function __$__115(__then) {
          ...
          options.operation = "remove";
          options.path = "";
          anySubItem = ((false || options.commandId) || options.parameters);
          if (anySubItem) {
            subItemPath = null;
            if (options.commandId) {
  ...
  setparametersRunCommandVirtualMachinesParameters0P1.command("set").description($("Set parameters in run-command-parameters string or files, e.g. \r\n         {\r\n           ...\r\n           \"parameters\" : {\r\n             \"name\":\"\",\r\n             \"value\":\"\"\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--value <value>", $("The input string value for the indexed item.")).option("--parse", $("Parse the input string, i.e. str, for parameters to a JSON object, e.g. JSON.parse(str).")).option("--name <name>", $("Set the name value.")).option("--value <value>", $("Set the value value.")).execute(function __116(options, _) { var fileContent, parametersObj, error, paramPath, updatedContent; var __frame = { name: "__116", line: 9501 }; return __func(_, this, arguments, __116, 1, __frame, function __$__116() {
  ...
  deleteparametersRunCommandVirtualMachinesParameters1P1.command("delete").description($("Remove parameters in run-command-parameters string or files, e.g. \r\n         {\r\n           ...\r\n           \"parameters\" : {\r\n             \"name\":\"\",\r\n             \"value\":\"\"\r\n           }\r\n           ...\r\n         }\r\n\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--index <index>", $("Indexer: index.")).option("--name", $("Remove the name value.")).option("--value", $("Remove the value value.")).execute(function __117(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__117", line: 9570 }; return __func(_, this, arguments, __117, 1, __frame, function __$__117() {
