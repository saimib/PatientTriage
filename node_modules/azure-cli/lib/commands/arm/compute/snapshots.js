...
exports.init = function(cli) {
  ...
  snapshotsCreateOrUpdatecreateOrUpdateParameters2.command("patch").description($("Command to patch snapshotsCreateOrUpdate parameter JSON file.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--operation <operation>", $("The JSON patch operation: add, remove, or replace.")).option("--path <path>", $("The JSON data path, e.g.: \"foo/1\".")).option("--value <value>", $("The JSON value.")).option("--parse", $("Parse the JSON value to object.")).execute(function __3(options, _) { var fileContent, snapshotObj, updatedContent; var __frame = { name: "__3", line: 471 }; return __func(_, this, arguments, __3, 1, __frame, function __$__3() {
  ...
  deleteparametersCreateOrUpdateSnapshotsSnapshot11.command("delete").description($("Remove snapshot in config string or files, e.g. \r\n{\r\n  \"sku\":{\r\n    \"name\":null,\r\n    \"tier\":\"\"\r\n  },\r\n  \"timeCreated\":null,\r\n  \"osType\":null,\r\n  \"creationData\":{\r\n    \"createOption\":\"\",\r\n    \"storageAccountId\":\"\",\r\n    \"imageReference\":{\r\n      \"id\":\"\",\r\n      \"lun\":null\r\n    },\r\n    \"sourceUri\":\"\",\r\n    \"sourceResourceId\":\"\"\r\n  },\r\n  \"diskSizeGB\":null,\r\n  \"encryptionSettings\":{\r\n    \"enabled\":null,\r\n    \"diskEncryptionKey\":{\r\n      \"sourceVault\":{\r\n        \"id\":\"\"\r\n      },\r\n      \"secretUrl\":\"\"\r\n    },\r\n    \"keyEncryptionKey\":{\r\n      \"sourceVault\":{\r\n        \"id\":\"\"\r\n      },\r\n      \"keyUrl\":\"\"\r\n    }\r\n  },\r\n  \"provisioningState\":\"\",\r\n  \"id\":null,\r\n  \"name\":null,\r\n  \"type\":null,\r\n  \"location\":\"\",\r\n  \"tags\":{\r\n  }\r\n}\r\n         There are two sets of commands:\r\n           1) function commands that are used to manage Azure resources in the cloud, and \r\n           2) parameter commands that generate & edit input files for the other set of commands.\r\n         For example, 'vmss show/list/stop' are the function commands that call get, list and stop operations of \r\n         virtual machine scale set, whereas 'vmss config * generate/create/set/delete/add' commands \r\n         are used to configure the input parameter file. The 'vmss config' command takes a parameter \r\n         file as for the VM scale set configuration, and creates it online.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--sku", $("Remove the sku value.")).option("--time-created", $("Remove the time-created value.")).option("--os-type", $("Remove the os-type value.")).option("--creation-data", $("Remove the creation-data value.")).option("--disk-size-g-b", $("Remove the disk-size-g-b value.")).option("--encryption-settings", $("Remove the encryption-settings value.")).option("--provisioning-state", $("Remove the provisioning-state value.")).option("--id", $("Remove the id value.")).option("--name", $("Remove the name value.")).option("--type", $("Remove the type value.")).option("--location", $("Remove the location value.")).option("--tags", $("Remove the tags value.")).execute(function __5(options, _) { var fileContent, parametersObj, anySubItem, subItemPath, updatedContent; var __frame = { name: "__5", line: 715 }; return __func(_, this, arguments, __5, 1, __frame, function __$__5() {
      ...
      return cli.output.verbose(JSON.stringify(options), __cb(_, __frame, 1, 15, function __$__5() { return (function __$__5(__then) {
          ...
          options.path = "";
          anySubItem = ((((((((((((false || options.sku) || options.timeCreated) || options.osType) || options.creationData) || options.diskSizeGB) || options.encryptionSettings) || options.provisioningState) || options.id) || options.name) || options.type) || options.location) || options.tags);
          if (anySubItem) {
            subItemPath = null;
            if (options.sku) {
  ...
  snapshotsDelete.command("delete [resource-group] [name]").description($("Deletes a snapshot.")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --name <name>", $("name")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __22(resourceGroup, name, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__22", line: 1789 }; return __func(_, this, arguments, __22, 3, __frame, function __$__22() { return (function __$__22(__then) {
  ...
  snapshotsGet.command("show [resource-group] [name]").description($("Gets information about a snapshot.")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --name <name>", $("name")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __23(resourceGroup, name, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__23", line: 1820 }; return __func(_, this, arguments, __23, 3, __frame, function __$__23() { return (function __$__23(__then) {
  ...
  snapshotsGrantAccessgrantAccessParameters2.command("patch").description($("Command to patch snapshotsGrantAccess parameter JSON file.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--operation <operation>", $("The JSON patch operation: add, remove, or replace.")).option("--path <path>", $("The JSON data path, e.g.: \"foo/1\".")).option("--value <value>", $("The JSON value.")).option("--parse", $("Parse the JSON value to object.")).execute(function __26(options, _) { var fileContent, grantAccessDataObj, updatedContent; var __frame = { name: "__26", line: 1917 }; return __func(_, this, arguments, __26, 1, __frame, function __$__26() {
  ...
  snapshotsListByResourceGroup.command("list [resource-group]").description($("Lists snapshots under a resource group.")).usage("[options] <resource-group>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __29(resourceGroup, options, _) { var subscription, computeManagementClient, result, nextPageLink, pageResult; var __frame = { name: "__29", line: 2085 }; return __func(_, this, arguments, __29, 2, __frame, function __$__29() {
  ...
  snapshotsRevokeAccess.command("revoke-access [resource-group] [name]").description($("Revokes access to a snapshot.")).usage("[options] <resource-group> <name>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-n, --name <name>", $("name")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __30(resourceGroup, name, options, _) { var subscription, computeManagementClient, result; var __frame = { name: "__30", line: 2131 }; return __func(_, this, arguments, __30, 3, __frame, function __$__30() { return (function __$__30(__then) {
  ...
  snapshotsUpdateupdateParameters2.command("create").description($("Generate snapshotsUpdate parameter string or files.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).execute(function __32(options, _) { var filePath; var __frame = { name: "__32", line: 2226 }; return __func(_, this, arguments, __32, 1, __frame, function __$__32() {
  ...
  snapshotsUpdateupdateParameters2.command("patch").description($("Command to patch snapshotsUpdate parameter JSON file.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--operation <operation>", $("The JSON patch operation: add, remove, or replace.")).option("--path <path>", $("The JSON data path, e.g.: \"foo/1\".")).option("--value <value>", $("The JSON value.")).option("--parse", $("Parse the JSON value to object.")).execute(function __33(options, _) { var fileContent, snapshotObj, updatedContent; var __frame = { name: "__33", line: 2246 }; return __func(_, this, arguments, __33, 1, __frame, function __$__33() {
