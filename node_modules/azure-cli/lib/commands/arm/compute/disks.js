...
exports.init = function(cli) {
  ...
  disksCreateOrUpdatecreateOrUpdateParameters2.command("patch").description($("Command to patch disksCreateOrUpdate parameter JSON file.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--operation <operation>", $("The JSON patch operation: add, remove, or replace.")).option("--path <path>", $("The JSON data path, e.g.: \"foo/1\".")).option("--value <value>", $("The JSON value.")).option("--parse", $("Parse the JSON value to object.")).execute(function __3(options, _) { var fileContent, diskObj, updatedContent; var __frame = { name: "__3", line: 474 }; return __func(_, this, arguments, __3, 1, __frame, function __$__3() {
  ...
  disksListByResourceGroup.command("list [resource-group]").description($("Lists all the disks under a resource group.")).usage("[options] <resource-group>").option("-g, --resource-group <resource-group>", $("resource-group")).option("-s, --subscription <subscription>", $("The subscription identifier")).execute(function __29(resourceGroup, options, _) { var subscription, computeManagementClient, result, nextPageLink, pageResult; var __frame = { name: "__29", line: 2105 }; return __func(_, this, arguments, __29, 2, __frame, function __$__29() {
      ...
      result = null; return (function __$__29(__then) {
        if (utils.stringIsNullOrEmpty(resourceGroup)) {
          ...
          return computeManagementClient.disks.listByResourceGroup(resourceGroup, __cb(_, __frame, 9, 45, function ___(__0, __2) { result = __2; __then(); }, true)); } ; })(function __$__29() {
  ...
  disksUpdateupdateParameters2.command("patch").description($("Command to patch disksUpdate parameter JSON file.")).usage("[options]").option("--parameter-file <parameter-file>", $("The parameter file path.")).option("--operation <operation>", $("The JSON patch operation: add, remove, or replace.")).option("--path <path>", $("The JSON data path, e.g.: \"foo/1\".")).option("--value <value>", $("The JSON value.")).option("--parse", $("Parse the JSON value to object.")).execute(function __33(options, _) { var fileContent, diskObj, updatedContent; var __frame = { name: "__33", line: 2266 }; return __func(_, this, arguments, __33, 1, __frame, function __$__33() {
